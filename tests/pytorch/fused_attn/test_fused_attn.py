...
def _run_dot_product_attention(
    ...
    out = block(q, k, v,
            ...
            cu_seqlens_q_with_padding=cu_seqlens_q_after_pad if backend == "FusedAttention" else None,
            cu_seqlens_kv_with_padding=cu_seqlens_kv_after_pad if backend == "FusedAttention" else None,
            attn_mask_type=config.attn_mask_type,
