...
def maybe_skip_quantization(
    ...
    *,
    ...
    if (
        quantization in ("nvfp4", "nvfp4_row_scaled", "nvfp4_rht")
...
class TestSequentialModules:
    ...
    def test_grouped_mlp(
        ...
        *,
        ...
        if (
            with_quantization
            and quantization in ("nvfp4", "nvfp4_row_scaled", "nvfp4_rht")
        ...
        if quantization in ("nvfp4", "nvfp4_row_scaled", "nvfp4_rht"):
