...
def test_nvfp4_row_scaled_quantizer_roles(
    ...
    def expected_e4m3_use_256(tensor_type):
    ...
    assert [q.four_over_six_e4m3_use_256 for q in forward_quantizers] == [
        expected_e4m3_use_256(tensor_type) for tensor_type in ("input", "weight", "output")
    ]
    ...
    assert [q.four_over_six_e4m3_use_256 for q in role_quantizers] == [
        expected_e4m3_use_256(tensor_type) for tensor_type in ("weight", "input", "output", "input")
    ]
    ...
    assert [q.four_over_six_e4m3_use_256 for q in backward_quantizers] == [
        expected_e4m3_use_256(tensor_type) for tensor_type in ("grad_output", "grad_input")
    ]
