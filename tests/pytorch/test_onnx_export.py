...
def trt_mxfp8_quantize(t):
    ...
    x = torch.from_numpy(t).cuda()
    q = te.tensor.mxfp8_tensor.MXFP8Quantizer(constants.DType.kFloat8E4M3)
...
def as_te_type(dtype: torch.dtype):
    return {
        torch.float32: constants.DType.kFloat32,
        torch.float16: constants.DType.kFloat16,
        torch.bfloat16: constants.DType.kBFloat16,
    }[dtype]
