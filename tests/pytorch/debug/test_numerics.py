...
def _emulate_linear(
    ...
    fprop_input_fake_quant: constants.DType = None,
    fprop_input_scale: torch.Tensor = None,
    fprop_weight_fake_quant: constants.DType = None,
    fprop_weight_scale: torch.Tensor = None,
    dgrad_fp8: bool = False,
    dgrad_gradient_fake_quant: constants.DType = None,
    dgrad_gradient_scale: torch.Tensor = None,
    dgrad_weight_fake_quant: constants.DType = None,
    dgrad_weight_scale: torch.Tensor = None,
    wgrad_fp8: bool = False,
    wgrad_gradient_fake_quant: constants.DType = None,
    wgrad_gradient_scale: torch.Tensor = None,
    wgrad_input_fake_quant: constants.DType = None,
...
def set_current_scaling_factors(x, weight, y, input_kwargs, fp8_kwargs):
    ...
    if input_kwargs["fprop_inp"]:
        fp8_kwargs["fprop_input_scale"] = constants.DType.kFloat8E4M3
    if input_kwargs["fprop_weight"]:
        fp8_kwargs["fprop_weight_scale"] = constants.DType.kFloat8E4M3
    if input_kwargs["dgrad_grad"]:
        fp8_kwargs["dgrad_gradient_scale"] = constants.DType.kFloat8E5M2
    if input_kwargs["dgrad_weight"]:
        fp8_kwargs["dgrad_weight_scale"] = constants.DType.kFloat8E4M3
    if input_kwargs["wgrad_grad"]:
        fp8_kwargs["wgrad_gradient_scale"] = constants.DType.kFloat8E5M2
    if input_kwargs["wgrad_input"]:
        fp8_kwargs["wgrad_input_scale"] = constants.DType.kFloat8E4M3
...
all_combinations = list(
    itertools.product([constants.DType.kFloat8E4M3, constants.DType.kFloat8E5M2, None], repeat=6)
)
...
def fake_quant_fp8_create_config(
    ...
    format_to_str = {constants.DType.kFloat8E4M3: "FP8E4M3", constants.DType.kFloat8E5M2: "FP8E5M2"}
    gemms = ""
