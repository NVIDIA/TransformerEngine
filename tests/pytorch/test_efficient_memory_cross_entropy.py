...
def check_cross_entropy_fwd_mean_log_cuda():
    ...
    mean_log_probs = tex.cross_entropy_fwd_mean_log_cuda(vocab_parallel_logits, logits_max, sum_exp_logits)
    print(mean_log_probs)
    

    print("-------------------------")

    mean_log_probs_torch = test_cross_entropy_fwd_mean_log_torch(vocab_parallel_logits, logits_max, sum_exp_logits)
...
def check_cross_entropy_bwd_cuda():
    ...
    grad_input_ptr = tex.cross_entropy_bwd_cuda(grad_output_ptr, input_ptr, target_mask_ptr, masked_target_1d_ptr, logits_max, sum_exp_logits, label_smoothing, vocab_size)
