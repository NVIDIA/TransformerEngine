...
def _test_quantizer(input_dtype, fp8_dtype):
    ...
    Args:
        ...
        fp8_dtype (constants.DType): The data type of the fp8.
    """
...
def test_quantizer():
    ...
    fp8_dtypes = [constants.DType.kFloat8E4M3, constants.DType.kFloat8E5M2]
...
def _test_quantized_all_gather(input_dtype, low_precision_dtype, quantizer_cls):
    ...
    Args:
        input_dtype (torch.dtype): The data type of the input.
        low_precision_dtype (constants.DType): The data type of the low precision, can be fp4 or fp8.
    """
...
def test_quantized_all_gather():
    ...
    fp8_dtype = [constants.DType.kFloat8E4M3, constants.DType.kFloat8E5M2]
