...
@pytest.mark.parametrize(
    ...
    [
        # large + QKV_PACKED and RAGGED_QKV_PACKED?
        pytest.param(2, 2048, 2048, 12, 12, 64, 64, jnp.bfloat16, QKVLayout.BS3HD, id="2-2048-2048-12-12-64-64-BF16-SELF-QKV_PACKED"),
        pytest.param(2, 2048, 2048, 12, 12, 64, 64, jnp.bfloat16, QKVLayout.T3HD, id="2-2048-2048-12-12-64-64-BF16-SELF-RAGGED_QKV_PACKED"),
        # mid + cross + KV_PACKED and RAGGED_KV_PACKED
        pytest.param(2, 512, 1024, 12, 12, 64, 64, jnp.bfloat16, QKVLayout.BSHD_BS2HD, id="2-512-1024-12-12-64-64-BF16-CROSS-KV_PACKED"),
        pytest.param(2, 512, 1024, 12, 12, 64, 64, jnp.bfloat16, QKVLayout.THD_T2HD, id="2-512-1024-12-12-64-64-BF16-CROSS-RAGGED_KV_PACKED"),
        # large + cross + diff hidden v dim + SEPARATE and RAGGED_SEPARATE ?
        pytest.param(2, 2048, 1024, 12, 12, 64, 32, jnp.bfloat16, QKVLayout.BSHD_BSHD_BSHD, id="2-2048-1024-12-12-64-32-BF16-CROSS-SEPARATE"),
        pytest.param(2, 2048, 1024, 12, 12, 64, 32, jnp.bfloat16, QKVLayout.THD_THD_THD, id="2-2048-1024-12-12-64-32-BF16-CROSS-RAGGED_SEPARATE"),
        # large + gqa + KV_PACKED and RAGGED_KV_PACKED ?
        pytest.param(2, 2048, 2048, 12, 6, 64, 64, jnp.bfloat16, QKVLayout.BSHD_BS2HD, id="2-2048-2048-12-6-64-64-BF16-GQA-KV_PACKED"),
        pytest.param(2, 2048, 2048, 12, 6, 64, 64, jnp.bfloat16, QKVLayout.THD_T2HD, id="2-2048-2048-12-6-64-64-BF16-GQA-RAGGED_KV_PACKED"),

        # small + fp16 + diff hidden v dim + QKV_PACKED and RAGGED_QKV_PACKED ?
        pytest.param(4, 128, 128, 16, 16, 64, 32, jnp.float16, QKVLayout.BS3HD, id="4-128-128-16-16-64-32-FP16-SELF-QKV_PACKED"),
        pytest.param(4, 128, 128, 16, 16, 64, 32, jnp.float16, QKVLayout.T3HD, id="4-128-128-16-16-64-32-FP16-SELF-RAGGED_QKV_PACKED"),
        # small + fp16 + KV_PACKED and RAGGED_KV_PACKED ?
        pytest.param(4, 128, 128, 16, 16, 64, 64, jnp.float16, QKVLayout.BSHD_BS2HD, id="4-128-128-16-16-64-64-FP16-SELF-KV_PACKED"),
        pytest.param(4, 128, 128, 16, 16, 64, 64, jnp.float16, QKVLayout.THD_T2HD, id="4-128-128-16-16-64-64-FP16-SELF-RAGGED_KV_PACKED"),
        # large + fp16 + gqa + diff hidden v dim + SEPARATE and RAGGED_SEPARATE ?
        # TODO: Consider making this a CROSS case ?
        pytest.param(2, 2048, 2048, 12, 6, 128, 64, jnp.float16, QKVLayout.BSHD_BSHD_BSHD, id="2-2048-2048-12-6-128-64-FP16-GQA-SEPARATE"),
        pytest.param(2, 2048, 2048, 12, 6, 128, 64, jnp.float16, QKVLayout.THD_THD_THD, id="2-2048-2048-12-6-128-64-FP16-GQA-RAGGED_SEPARATE"),
    ],
)
@pytest.mark.parametrize(
    "dropout_prob",
