...
python3 -m pytest --tb=auto --junitxml=$XML_LOG_DIR/pytest_test_recipe_update.xml $TE_PATH/tests/pytorch/test_recipe_update.py || test_fail "test_recipe_update.py"
python3 -m pytest --tb=auto --junitxml=$XML_LOG_DIR/pytest_test_hybrid_quantization_fsdp2.xml $TE_PATH/tests/pytorch/test_hybrid_quantization_fsdp2.py || test_fail "test_hybrid_quantization_fsdp2.py"
