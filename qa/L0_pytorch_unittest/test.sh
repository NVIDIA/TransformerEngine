...
NVTE_WARN_IF_CUTEDSL_BACKEND_NOT_CHOSEN=1  python3 -m pytest --tb=auto --junitxml=$XML_LOG_DIR/pytest_test_mxfp8.xml $TE_PATH/tests/pytorch/mxfp8 || test_fail "test_mxfp8"
