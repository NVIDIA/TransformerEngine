...
python3 -m pytest --tb=auto --junitxml=$XML_LOG_DIR/pytest_test_float8_view_shape.xml $TE_PATH/tests/pytorch/test_float8_view_shape.py || test_fail "test_float8_view_shape.py"
