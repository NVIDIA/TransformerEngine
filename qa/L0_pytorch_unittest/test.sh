...
python3 -m pytest --tb=auto --junitxml=$XML_LOG_DIR/pytest_test_fa4_window_sentinel.xml $TE_PATH/tests/pytorch/attention/test_fa4_window_sentinel.py || test_fail "test_fa4_window_sentinel.py"
