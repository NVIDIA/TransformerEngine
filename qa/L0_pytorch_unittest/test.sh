...
python3 -m pytest --tb=auto --junitxml=$XML_LOG_DIR/pytest_test_gemm_bias_dtype.xml $TE_PATH/tests/pytorch/test_gemm_bias_dtype.py || test_fail "test_gemm_bias_dtype.py"
