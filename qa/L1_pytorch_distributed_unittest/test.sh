...
python3 -m pytest -v -s --junitxml=$XML_LOG_DIR/pytest_test_backward_update_ranks.xml $TE_PATH/tests/pytorch/distributed/test_backward_update_ranks.py || test_fail "test_backward_update_ranks.py"
