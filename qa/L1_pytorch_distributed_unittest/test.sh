...
python3 -m pytest -v -s --junitxml=$XML_LOG_DIR/pytest_test_fused_attn_with_cp.xml $TE_PATH/tests/pytorch/attention/test_fused_attn_with_cp.py || test_fail "test_fused_attn_with_cp.py"
