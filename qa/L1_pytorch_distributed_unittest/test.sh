...
python3 -m pytest -v -s --junitxml=$XML_LOG_DIR/pytest_test_benchmarkable_linear.xml $TE_PATH/tests/pytorch/distributed/test_benchmarkable_linear.py || test_fail "test_benchmarkable_linear.py"
