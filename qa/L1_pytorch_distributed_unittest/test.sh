...
python3 -m pytest -v -s --junitxml=$XML_LOG_DIR/pytest_test_frozen_weight_columnwise_release.xml $TE_PATH/tests/pytorch/distributed/test_frozen_weight_columnwise_release.py || test_fail "test_frozen_weight_columnwise_release.py"
