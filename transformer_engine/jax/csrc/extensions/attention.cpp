...
Error_Type FusedAttnForwardInitializeFFI(
    ...
    Buffer_Type k_seq_offsets_buf, Variadic_Buffer_Type _unused_args, Result_Type output_buf,
    Result_Type softmax_aux_buf, Result_Type rng_state_buf, Result_Type workspace_buf,
    Dictionary attrs) {
...
Error_Type FusedAttnBackwardInitializeFFI(
    cudaStream_t stream, Buffer_Type q_buf, Buffer_Type k_buf, Buffer_Type v_buf,
    Buffer_Type bias_buf, Buffer_Type softmax_offset_buf, Buffer_Type softmax_aux_buf,
  ...
  return wrapInStreamCapture(std::function(FusedAttnBackwardFFI), stream, q_buf, k_buf, v_buf,
                             ...
                             q_seq_offsets_buf, k_seq_offsets_buf, _unused_args, dq_buf, dk_buf,
                             dv_buf, dbias_buf, dsoftmax_offset_buf, workspace_buf, attrs);
}
