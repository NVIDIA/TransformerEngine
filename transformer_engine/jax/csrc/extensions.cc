...
pybind11::dict TERegistrations() {
  ...
  dict["te_gated_gelu_fp8"] =
      te_jax::EncapsulateFunction(te_jax::TEGatedGeluFP8);
  dict["te_dgated_gelu"] = te_jax::EncapsulateFunction(te_jax::TEDGatedGelu);
  dict["te_cast_transpose_dgated_gelu"] =
      te_jax::EncapsulateFunction(te_jax::TEDGatedGeluCastTranspose);
  dict["te_gemm"] = te_jax::EncapsulateFunction(te_jax::TEGemm);
  dict["te_layernorm_forward"] =
      te_jax::EncapsulateFunction(te_jax::TELayerNormForward);
  dict["te_layernorm_forward_fp8"] =
      te_jax::EncapsulateFunction(te_jax::TELayerNormForwardFP8);
  dict["te_layernorm_backward"] =
      te_jax::EncapsulateFunction(te_jax::TELayerNormBackward);
...
PYBIND11_MODULE(transformer_engine_jax, m) {
  ...
  m.def("build_te_layernorm_descriptor", &te_jax::PackLayerNormDescriptor);
