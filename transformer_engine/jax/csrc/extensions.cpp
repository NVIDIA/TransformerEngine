...
PYBIND11_MODULE(transformer_engine_jax, m) {
    ...
    pybind11::enum_<NVTE_Activation_Enum>(m, "NVTE_Activation_Enum", pybind11::module_local())
        ...
        .value("RELU", NVTE_Activation_Enum::RELU)
        .value("REGLU", NVTE_Activation_Enum::REGLU)
        .value("QGELU", NVTE_Activation_Enum::QGELU)
        .value("QGEGLU", NVTE_Activation_Enum::QGEGLU)
        .value("SRELU", NVTE_Activation_Enum::SRELU)
        .value("SREGLU", NVTE_Activation_Enum::SREGLU);
