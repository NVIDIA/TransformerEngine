...
def ep_bootstrap(
    ...
    ``MeshResource.ep_resource`` when provided; axes outside the ordered EP
    tuple form separate EP domains. The communicator is auto-selected between
    self-hosted NCCL and XLA's borrowed comm (see
