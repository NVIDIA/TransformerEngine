...
def dense(
    ...
    if quantizer_set == noop_quantizer_set and tex.gemm_uses_jax_dot():
        ...
        output = _dense(x, kernel, bias, contracting_dims, input_axes, kernel_axes, batch_first,
                        quantizer_set)
    return output
...
def _dense_fwd_rule(x, kernel, bias, contracting_dims, input_axes, kernel_axes,
                    batch_first, quantizer_set):
...
def _dense_bwd_rule(
    ...
    wgrad = tex.gemm(
        ...
        dimension_numbers=((x_contracting_dim, g_contracting_dim), ((x_bdim, ), ())),
    )
