...
def _gemm_fwd_rule(
    ...
    out, pre_gelu_out, _ = collective_gemm_impl(
        x,
        kernel,
        bias=bias,
...
def _gemm_bwd_rule(
    ...
    dgrad, dgelu, _ = collective_gemm_impl(
        grad,
        kernel,
    ...
    wgrad, _, bgrad = collective_gemm_impl(
        x,
        wgrad_rhs,
        gelu_input=pre_gelu_out,
...
def _fp8_gemm_fwd_rule(
    ...
    out, updated_out_amax, updated_out_scale, pre_gelu_out = collective_fp8_gemm_impl(
        casted_x,
        x_scale_inv,
        casted_kernel_t,
        kernel_scale_inv,
...
def _fp8_gemm_bwd_rule(
    ...
    kernel_scale_inv = scale_inv_list[FP8MetaPackage.WEIGHT_IDX]
    dgrad, *_ = collective_fp8_gemm_impl(
        casted_grad,
        grad_scale_inv,
        casted_kernel,
        kernel_scale_inv,
    ...
    x_scale_inv = scale_inv_list[FP8MetaPackage.INPUT_IDX]
    wgrad, *_ = collective_fp8_gemm_impl(
        casted_x_t,
        x_scale_inv,
        casted_grad_t,
        grad_scale_inv,
