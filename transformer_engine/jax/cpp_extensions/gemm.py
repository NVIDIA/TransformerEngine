...
def _jax_gemm_tensor_scaling_fp8(
    ...
    assert (
        rhs.scaling_mode in (ScalingMode.DELAYED_TENSOR_SCALING, ScalingMode.CURRENT_TENSOR_SCALING)
...
def _jax_gemm(
    ...
    def _jax_gemm_fp8_impl(lhs, rhs):
        ...
        if lhs.scaling_mode in (ScalingMode.DELAYED_TENSOR_SCALING, ScalingMode.CURRENT_TENSOR_SCALING):
...
def grouped_gemm(
    ...
    for i in range(num_gemms):
        ...
        elif scaling_mode in (ScalingMode.DELAYED_TENSOR_SCALING, ScalingMode.CURRENT_TENSOR_SCALING):
