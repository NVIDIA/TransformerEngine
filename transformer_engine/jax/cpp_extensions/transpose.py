...
class TransposePrimitive(BasePrimitive):
    ...
    @staticmethod
    def lowering(ctx, x, *, transpose_axis_boundary):
        """
        ...
        return ffi.ffi_lowering(name)(ctx, x, transpose_axis=transpose_axis_boundary)
...
class CastTransposePrimitive(BasePrimitive):
    ...
    @staticmethod
    def lowering(
        ctx, x, amax, scale, scale_inv, *, transpose_axis_boundary
    ):
        """
        ...
        return ffi.ffi_lowering(name, operand_output_aliases={1: 2})(
...
class DBiasCastTransposePrimitive(BasePrimitive):
    ...
    @staticmethod
    def lowering(
        ctx, dz, amax, scale, scale_inv, *, transpose_axis_boundary
    ):
        """
        ...
        return ffi.ffi_lowering(name, operand_output_aliases={1: 3})(
...
class DActLuDBiasCastTransposePrimitive(BasePrimitive):
    ...
    @staticmethod
    def lowering(ctx, dz, x, amax, scale, scale_inv, *, act_enum):
        """
        ...
        return ffi.ffi_lowering(name, operand_output_aliases={2: 3})(
