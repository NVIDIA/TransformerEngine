...
class RowIdMapPass1Primitive(BasePrimitive):
    ...
    def abstract(routing_map_aval, *, num_tokens, num_experts, block_size):
        ...
        workspace_shape = (
            num_experts,
            triton.cdiv(num_tokens, 1024),
        )  # Use default block_size for shape
...
class RowIdMapPass2Primitive(BasePrimitive):
    ...
    def abstract(_row_id_map_aval, _workspace_aval, *, num_tokens, num_experts, block_size):
        ...
        row_id_map_shape = (num_tokens, num_experts * 2 + 1)
        workspace_shape = (num_experts, triton.cdiv(num_tokens, 1024))
...
class PermuteWithMaskMapPrimitive(BasePrimitive):
    ...
    def lowering(
        ...
        *,
        ...
        # For autotuned kernel, we use a fixed reasonable block size for grid calculation
        block_size = 128
