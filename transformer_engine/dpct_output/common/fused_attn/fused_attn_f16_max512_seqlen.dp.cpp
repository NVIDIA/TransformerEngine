...
static void createScale(int64_t b, int64_t h, int64_t s_q, int64_t s_kv,
    ...
    /*
    DPCT1007:232: Migration of CUDNN_POINTWISE_MUL is not supported.
    */
    auto scaleDesc =
...
createBMM1(int64_t b, int64_t h, int64_t s_q, int64_t s_kv, int64_t d,
           NVTE_QKV_Layout layout, dpct::library_data_t tensorType, bool zero_s,
           // NOLINTNEXTLINE(runtime/references)
           std::vector<cudnn_frontend::Operation> &ops) {
    ...
    auto afterScaleKTensor =
        tensor_create(tensorType, VIRTUAL_ID, k_dim, k_stride, true, false);  // is virtual
    // first GEMM output
    auto pTensor = tensor_create(dpct::library_data_t::real_float,
                                 VIRTUAL_ID + 1, p_dim, p_stride, true,
                                 false); // is virtual

    auto seqlenQTensor =
        tensor_create(dpct::library_data_t::real_int32, Q_SEQLEN_ID, seqlen_dim,
                      seqlen_stride, false, false);
    auto seqlenKTensor =
        tensor_create(dpct::library_data_t::real_int32, K_SEQLEN_ID, seqlen_dim,
                      seqlen_stride, false, false);
    ...
    /*
    DPCT1007:233: Migration of CUDNN_BACKEND_OPERATION_MATMUL_DESCRIPTOR is not
    supported.
    */
...
static cudnn_frontend::Tensor
createBias(int64_t b, int64_t h, int64_t s_q, int64_t s_kv, int64_t d,
    ...
    // output
    auto afterBiasTensor = tensor_create(
        dpct::library_data_t::real_float, VIRTUAL_ID + 50, afterBias_dim,
        afterBias_stride, true, false); // is virtual

    // Define the bias descriptor
    /*
    DPCT1007:234: Migration of CUDNN_POINTWISE_ADD is not supported.
    */
    auto biasDesc =
        pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_ADD);
...
static cudnn_frontend::Tensor
createMask(int64_t b, int64_t h, int64_t s_q, int64_t s_kv, int64_t d,
           NVTE_QKV_Layout layout, NVTE_Mask_Type mask_type,
           dpct::library_data_t tensorType,
           // NOLINTNEXTLINE(runtime/references)
           std::vector<cudnn_frontend::Operation> &ops,
           cudnn_frontend::Tensor const &prevBlockOutputTensor, bool is_bprop) {
    ...
    auto maskValTensor =
        tensor_create(dpct::library_data_t::real_float, MASK_VAL_ID,
    ...
    auto rowIndexTensor = tensor_create(
        dpct::library_data_t::real_float, VIRTUAL_ID + 100, afterBMM1_dim,
        afterBMM1_stride, true, false); // is virtual
    // gen index column output
    auto columnIndexTensor = tensor_create(
        dpct::library_data_t::real_float, VIRTUAL_ID + 101, afterBMM1_dim,
        afterBMM1_stride, true, false); // is virtual
    // less than row output
    auto lessThanRowTensor =
        /*
        DPCT1007:235: Migration of CUDNN_DATA_BOOLEAN is not supported.
        */
        tensor_create(CUDNN_DATA_BOOLEAN, VIRTUAL_ID + 102, afterBMM1_dim,
                      afterBMM1_stride, true,
                      false); // is virtual
                              // less than column output
    /*
    DPCT1007:236: Migration of CUDNN_DATA_BOOLEAN is not supported.
    */
    ...
    /*
    DPCT1007:237: Migration of CUDNN_DATA_BOOLEAN is not supported.
    */
    ...
    /*
    DPCT1007:238: Migration of CUDNN_DATA_BOOLEAN is not supported.
    */
    ...
    /*
    DPCT1007:239: Migration of CUDNN_DATA_BOOLEAN is not supported.
    */
    ...
    dpct::library_data_t maskOutputTensor_dataType =
    ...
    auto genIndexRowDesc = cudnn_frontend::PointWiseDescBuilder()
                               /*
                               DPCT1007:240: Migration of
                               CUDNN_POINTWISE_GEN_INDEX is not supported.
                               */
    ...
    auto genIndexColumnDesc =
        cudnn_frontend::PointWiseDescBuilder()
            /*
            DPCT1007:241: Migration of CUDNN_POINTWISE_GEN_INDEX is not
            supported.
            */
            .setMode(CUDNN_POINTWISE_GEN_INDEX)
            .setAxis(3)
    ...
    /*
    DPCT1007:242: Migration of CUDNN_POINTWISE_CMP_LT is not supported.
    */
    auto lessThanRowDesc = pw_desc_create(dpct::library_data_t::real_float,
    ...
    /*
    DPCT1007:243: Migration of CUDNN_POINTWISE_CMP_LT is not supported.
    */
    auto lessThanColDesc = pw_desc_create(dpct::library_data_t::real_float,
                                          CUDNN_POINTWISE_CMP_LT);
    ...
    // Define the less than comparison for column descriptor
    /*
    DPCT1007:244: Migration of CUDNN_DATA_BOOLEAN is not supported.
    */
    /*
    DPCT1007:245: Migration of CUDNN_POINTWISE_LOGICAL_AND is not supported.
    */
    ...
    /*
    DPCT1007:246: Migration of CUDNN_DATA_BOOLEAN is not supported.
    */
    /*
    DPCT1007:247: Migration of CUDNN_POINTWISE_CMP_GE is not supported.
    */
    ...
    /*
    DPCT1007:248: Migration of CUDNN_DATA_BOOLEAN is not supported.
    */
    /*
    DPCT1007:249: Migration of CUDNN_POINTWISE_LOGICAL_AND is not supported.
    */
    ...
    /*
    DPCT1007:250: Migration of CUDNN_POINTWISE_BINARY_SELECT is not supported.
    */
    auto maskDesc = pw_desc_create(dpct::library_data_t::real_float,
...
static cudnn_frontend::Tensor
createSoftmaxForward(int64_t b, int64_t h, int64_t s_q, int64_t s_kv, int64_t d,
                     NVTE_QKV_Layout layout, bool enable_dropout,
    ...
    dpct::library_data_t softmaxOutputType =
        enable_dropout ? dpct::library_data_t::real_float : tensorType;
    uint64_t softmaxOutputName = softmax_output_virtual ? VIRTUAL_ID + 154 : S_ID;

    // max (x)
    auto afterMaxReductionTensor = tensor_create(
        dpct::library_data_t::real_float, VIRTUAL_ID + 150, afterReduction_dim,
        afterReduction_stride, true, false); // is virtual
    // x - max(x)
    auto afterSubtractionTensor = tensor_create(
        dpct::library_data_t::real_float, VIRTUAL_ID + 151, afterBMM1_dim,
        afterBMM1_stride, true, false); // is virtual
    // e^(x - max(x))
    auto afterExponentTensor = tensor_create(
        dpct::library_data_t::real_float, VIRTUAL_ID + 152, afterBMM1_dim,
        afterBMM1_stride, true, false); // is virtual;
    // sum (e^(x - max(x)))
    auto afterAddReductionTensor = tensor_create(
        dpct::library_data_t::real_float, VIRTUAL_ID + 153, afterReduction_dim,
        afterReduction_stride, true, false); // is virtual
    // divide (e/ sum(e))
    ...
    auto reductionMax_op =
        /*
        DPCT1007:251: Migration of CUDNN_BACKEND_OPERATION_REDUCTION_DESCRIPTOR
        is not supported.
        */
    ...
    /*
    DPCT1007:252: Migration of CUDNN_POINTWISE_SUB is not supported.
    */
    auto subtractDesc =
    ...
    /*
    DPCT1007:253: Migration of CUDNN_POINTWISE_EXP is not supported.
    */
    auto exponentDesc =
    ...
    auto reductionAdd_op =
        /*
        DPCT1007:254: Migration of CUDNN_BACKEND_OPERATION_REDUCTION_DESCRIPTOR
        is not supported.
        */
        cudnn_frontend::OperationBuilder(
            CUDNN_BACKEND_OPERATION_REDUCTION_DESCRIPTOR)
    ...
    /*
    DPCT1007:255: Migration of CUDNN_POINTWISE_DIV is not supported.
    */
    auto divisionDesc =
        pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_DIV);
...
static cudnn_frontend::Tensor
createDropout(int64_t b, int64_t h, int64_t s_q, int64_t s_kv, int64_t d,
              double probability, dpct::library_data_t tensorType,
              // NOLINTNEXTLINE(runtime/references)
              std::vector<cudnn_frontend::Operation> &ops,
              cudnn_frontend::Tensor const &prevBlockOutputTensor) {
    ...
    auto dropoutMaskTensor = tensor_create(
        dpct::library_data_t::real_float, VIRTUAL_ID + 200, afterBMM1_dim,
        afterBMM1_stride, true, false); // is virtual
    ...
    auto rngDesc = cudnn_frontend::RngDescBuilder()
                       /*
                       DPCT1007:256: Migration of
                       CUDNN_RNG_DISTRIBUTION_BERNOULLI is not supported.
                       */
    ...
    auto dropoutSeed =
        /*
        DPCT1007:257: Migration of CUDNN_DATA_INT64 is not supported.
        */
        tensor_create(CUDNN_DATA_INT64, DROPOUT_SEED_ID, scale_dim,
                      scale_stride, false, false);
    auto dropoutOffset =
        /*
        DPCT1007:258: Migration of CUDNN_DATA_INT64 is not supported.
        */
        tensor_create(CUDNN_DATA_INT64, DROPOUT_OFFSET_ID, scale_dim,
                      scale_stride, false, false);

    // Create a rng Node.
    /*
    DPCT1007:259: Migration of CUDNN_BACKEND_OPERATION_RNG_DESCRIPTOR is not
    supported.
    */
    auto rng_op =
    ...
    /*
    DPCT1007:260: Migration of CUDNN_POINTWISE_MUL is not supported.
    */
    auto maskMulDesc =
        pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_MUL);
    ...
    /*
    DPCT1007:261: Migration of CUDNN_POINTWISE_MUL is not supported.
    */
    auto scaleMulDesc =
        pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_MUL);
...
static void createBMM2(int64_t b, int64_t h, int64_t s_q, int64_t s_kv,
    ...
    /*
    DPCT1007:262: Migration of CUDNN_BACKEND_OPERATION_MATMUL_DESCRIPTOR is not
    supported.
    */
...
static cudnn_frontend::Tensor
createSoftmaxBackward(int64_t b, int64_t h, int64_t s_q, int64_t s_kv,
                      int64_t d, NVTE_QKV_Layout layout,
                      dpct::library_data_t tensorType,
                      // NOLINTNEXTLINE(runtime/references)
                      std::vector<cudnn_frontend::Operation> &ops,
    ...
    auto softmaxScaleTensor =
        tensor_create(dpct::library_data_t::real_float, S_CONST_ID, const_dim,
                      const_stride, false, true);
    auto dyMulYTensor =
        tensor_create(dpct::library_data_t::real_float, VIRTUAL_ID + 250, p_dim,
                      p_stride, true, false);
    auto dxAfterReductionTensor =
        tensor_create(dpct::library_data_t::real_float, VIRTUAL_ID + 251,
                      p_reduction_dim, p_reduction_stride, true, false);
    auto dxAfterSubtractionTensor =
        tensor_create(dpct::library_data_t::real_float, VIRTUAL_ID + 252, p_dim,
                      p_stride, true, false);
    auto dxUnscaleTensor =
        tensor_create(dpct::library_data_t::real_float, VIRTUAL_ID + 253, p_dim,
                      p_stride, true, false);
    auto dxTensor =
        tensor_create(dpct::library_data_t::real_float, VIRTUAL_ID + 254, p_dim,
                      p_stride, true, false);

    // creating all ops
    // mul (y * dy)
    /*
    DPCT1007:263: Migration of CUDNN_POINTWISE_MUL is not supported.
    */
    auto mul_1_desc =
        pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_MUL);
    ...
    auto reductionAdd_op =
        /*
        DPCT1007:264: Migration of CUDNN_BACKEND_OPERATION_REDUCTION_DESCRIPTOR
        is not supported.
        */
        cudnn_frontend::OperationBuilder(
            CUDNN_BACKEND_OPERATION_REDUCTION_DESCRIPTOR)
    ...
    /*
    DPCT1007:265: Migration of CUDNN_POINTWISE_SUB is not supported.
    */
    auto sub_0_desc =
        pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_SUB);
    auto sub_0_op =
    ...
    // mul (y * (dy - sum(y * dy)))
    /*
    DPCT1007:266: Migration of CUDNN_POINTWISE_MUL is not supported.
    */
    auto mul_2_desc =
        pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_MUL);
    auto mul_2_op =
    ...
    // mul (scale * dx)
    /*
    DPCT1007:267: Migration of CUDNN_POINTWISE_MUL is not supported.
    */
    auto mul_3_desc =
        pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_MUL);
...
void fused_attn_max_512_fwd_impl(
    ...
    void *devPtrQ, void *devPtrK, void *devPtrV, void *devPtrS, void *devPtrO,
    void *devPtrBias, void *devPtrCuSeqlenQ, void *devPtrCuSeqlenKV,
    void *devPtrDropoutSeed, void *devPtrDropoutOffset, void *workspace,
    size_t *workspace_size, dpct::library_data_t tensorType,
    ...
    try {
        ...
        auto get_plan = [&](CacheType &cache, const FADescriptor &descriptor) {
            ...
            createScale(b, h, s_q, s_kv, d, layout, dpct::library_data_t, ops);
        ...
        /*
        DPCT1009:268: SYCL uses exceptions to report errors and does not use the
        error codes. The original code was commented out and a warning string
        was inserted. You need to rewrite this code.
        */
        NVTE_CHECK_CUDNN(DPCT_CHECK_ERROR(handle.set_queue(stream)));
        ...
        stream->parallel_for(
            sycl::nd_range<3>(sycl::range<3>(1, 1, grid) *
                                  sycl::range<3>(1, 1, nthreads_per_block),
                              sycl::range<3>(1, 1, nthreads_per_block)),
            [=](sycl::nd_item<3> item_ct1) {
                cu_seqlens_to_actual_seqlens(
                    ...
                    static_cast<int32_t *>(devActualSeqlenK), item_ct1);
            });
        /*
        DPCT1010:269: SYCL uses exceptions to report errors and does not use the
        error codes. The call was replaced with 0. You need to rewrite this
        code.
        */
        /*
        DPCT1009:270: SYCL uses exceptions to report errors and does not use the
        error codes. The original code was commented out and a warning string
        was inserted. You need to rewrite this code.
        */
        NVTE_CHECK_CUDA(0);
        ...
        sycl::half half_cast_scaling_factor{scaling_factor};
        sycl::ext::oneapi::bfloat16 bfloat_cast_scaling_factor{scaling_factor};

        if (tensorType == dpct::library_data_t::real_float) {
            data_ptrs.insert(std::pair<uint64_t, void *>(S_CONST_ID, &scaling_factor));
        } else if (tensorType == dpct::library_data_t::real_half) {
            data_ptrs.insert(std::pair<uint64_t, void *>(S_CONST_ID, &half_cast_scaling_factor));
        } else if (tensorType == dpct::library_data_t::real_bfloat16) {
        ...
        sycl::half half_cast_scale_dropout{scale_dropout};
        sycl::ext::oneapi::bfloat16 bfloat16_cast_scale_dropout{scale_dropout};
        ...
        /*
        DPCT1009:272: SYCL uses exceptions to report errors and does not use the
        error codes. The original code was commented out and a warning string
        was inserted. You need to rewrite this code.
        */
        /*
        DPCT1007:271: Migration of cudnnBackendExecute is not supported.
        */
        NVTE_CHECK_CUDNN(cudnnBackendExecute(handle, plan.get_raw_desc(),
...
void fused_attn_max_512_bwd_impl(
    ...
    NVTE_Mask_Type mask_type, NVTE_Bias_Type bias_type, void *devPtrQ,
    void *devPtrK, void *devPtrV, void *devPtrS, void *devPtrdQ, void *devPtrdK,
    ...
    try {
        ...
        auto get_plan = [&](CacheType &cache, const FADescriptor &descriptor) {
            ...
            // inputs to fprop
            auto qTensor = tensor_create(dpct::library_data_t, Q_ID, q_dim,
                                         q_stride, false, false);
            auto kTensor = tensor_create(tensorType, K_ID, k_dim, k_stride, false, false);
            auto vTensor = tensor_create(tensorType, V_ID, v_dim, v_stride, false, false);
            auto seqlenQTensor =
                tensor_create(dpct::library_data_t::real_int32, Q_SEQLEN_ID,
                              seqlen_dim, seqlen_stride, false, false);
            auto seqlenKTensor =
                tensor_create(dpct::library_data_t::real_int32, K_SEQLEN_ID,
                              seqlen_dim, seqlen_stride, false, false);
            ...
            auto reshape_op =
                /*
                DPCT1007:273: Migration of
                CUDNN_BACKEND_OPERATION_RESHAPE_DESCRIPTOR is not supported.
                */
                cudnn_frontend::OperationBuilder(
            ...
            // scale dropout
            auto dropoutScaleTensor = tensor_create(
                dpct::library_data_t::real_float, DROPOUT_CONST_ID, scale_dim,
                scale_stride, false, true); // is by value
            auto pAfterScaleTensor = tensor_create(tensorType, VIRTUAL_ID + 301, p_transpose_dim,
                                                   p_transpose_stride, true, false);

            /*
            DPCT1007:274: Migration of CUDNN_POINTWISE_MUL is not supported.
            */
            auto scaleMulDesc = pw_desc_create(dpct::library_data_t::real_float,
                                               CUDNN_POINTWISE_MUL);
            ...
            /*
            DPCT1007:275: Migration of CUDNN_POINTWISE_ABS is not supported.
            */
            auto absDesc = pw_desc_create(dpct::library_data_t::real_float,
                                          CUDNN_POINTWISE_ABS);
            ...
            // behaviour)
            auto matmul_0_Desc =
                cudnn_frontend::MatMulDescBuilder()
                    .setComputeType(dpct::library_data_t::real_float)
                    .setPaddingValue(0.0f)
                    .build();
            ...
            auto matmul_op0 =
                /*
                DPCT1007:276: Migration of
                CUDNN_BACKEND_OPERATION_MATMUL_DESCRIPTOR is not supported.
                */
                cudnn_frontend::OperationBuilder(
                    CUDNN_BACKEND_OPERATION_MATMUL_DESCRIPTOR)
            ...
            auto dpTensor =
                tensor_create(dpct::library_data_t::real_float,
                              VIRTUAL_ID + 303, p_dim, p_stride, true, false);
            ...
            /*
            DPCT1007:278: Migration of CUDNN_POINTWISE_ABS is not supported.
            */
            auto p_absDesc = pw_desc_create(dpct::library_data_t::real_float,
                                            CUDNN_POINTWISE_ABS);
            auto p_abs_op = unary_pw_op_create(pTensor, pAbsTensor, p_absDesc);
            ops.push_back(std::move(p_abs_op));

            // create the dropout mask
            auto zeroTensor = tensor_create(
                dpct::library_data_t::real_float, MASK_VAL_ID, scale_dim,
                scale_stride, false, true); // is by value
            auto dropoutMaskTensor =
                /*
                DPCT1007:279: Migration of CUDNN_DATA_BOOLEAN is not supported.
                */
                tensor_create(CUDNN_DATA_BOOLEAN, VIRTUAL_ID + 305, p_dim,
                              p_stride, true, false);

            /*
            DPCT1007:280: Migration of CUDNN_POINTWISE_CMP_GT is not supported.
            */
            auto greater_than_0_desc = pw_desc_create(
                dpct::library_data_t::real_float, CUDNN_POINTWISE_CMP_GT);
            ...
            auto dpAfterScaleTensor =
                tensor_create(dpct::library_data_t::real_float,
                              VIRTUAL_ID + 306, p_dim, p_stride, true, false);

            /*
            DPCT1007:281: Migration of CUDNN_POINTWISE_MUL is not supported.
            */
            auto mul_0_desc = pw_desc_create(dpct::library_data_t::real_float,
                                             CUDNN_POINTWISE_MUL);
            auto mul_0_op =
            ...
            auto dpAfterDropoutTensor =
                tensor_create(dpct::library_data_t::real_float,
                              VIRTUAL_ID + 307, p_dim, p_stride, true, false);

            /*
            DPCT1007:282: Migration of CUDNN_POINTWISE_BINARY_SELECT is not
            supported.
            */
            auto selection_0_desc =
                pw_desc_create(dpct::library_data_t::real_float,
                               CUDNN_POINTWISE_BINARY_SELECT);
            auto selection_0_op =
            ...
            if (bias_type == NVTE_Bias_Type::NVTE_POST_SCALE_BIAS) {
                auto softmaxScaleTensor =
                    tensor_create(dpct::library_data_t::real_float, S_CONST_ID,
                                  scale_dim, scale_stride, false, true);
                auto softmaxScaleReciprocalTensor = tensor_create(
                    dpct::library_data_t::real_float, VIRTUAL_ID + 401,
                    scale_dim, scale_stride, true, false);
                auto dbiasBeforeScaleTensor = tensor_create(
                    dpct::library_data_t::real_float, VIRTUAL_ID + 402,
                ...
                auto reductionAdd_op =
                    /*
                    DPCT1007:283: Migration of
                    CUDNN_BACKEND_OPERATION_REDUCTION_DESCRIPTOR is not
                    supported.
                    */
                    cudnn_frontend::OperationBuilder(
                        CUDNN_BACKEND_OPERATION_REDUCTION_DESCRIPTOR)
                ...
                auto reciprocal_scale_desc =
                    /*
                    DPCT1007:284: Migration of CUDNN_POINTWISE_RECIPROCAL is not
                    supported.
                    */
                    pw_desc_create(dpct::library_data_t::real_float,
                ...
                // apply the scale
                /*
                DPCT1007:285: Migration of CUDNN_POINTWISE_MUL is not supported.
                */
                auto dBias_scale_desc = pw_desc_create(
                    dpct::library_data_t::real_float, CUDNN_POINTWISE_MUL);
                auto dBias_scale_op =
        ...
        // null streams for sizing the cuDNN workspace.
        /*
        DPCT1009:289: SYCL uses exceptions to report errors and does not use the
        error codes. The original code was commented out and a warning string
        was inserted. You need to rewrite this code.
        */
        NVTE_CHECK_CUDNN(DPCT_CHECK_ERROR(handle.set_queue(stream)));
        ...
        */
        /*
        DPCT1009:291: SYCL uses exceptions to report errors and does not use the
        error codes. The original code was commented out and a warning string
        was inserted. You need to rewrite this code.
        */
        NVTE_CHECK_CUDA(0);
        ...
        /*
        DPCT1009:293: SYCL uses exceptions to report errors and does not use the
        error codes. The original code was commented out and a warning string
        was inserted. You need to rewrite this code.
        */
        /*
        DPCT1007:292: Migration of cudnnBackendExecute is not supported.
        */
        NVTE_CHECK_CUDNN(cudnnBackendExecute(handle, plan.get_raw_desc(),
                                             variantPack.get_raw_desc()));
    } catch (cudnn_frontend::cudnnException &e) {
