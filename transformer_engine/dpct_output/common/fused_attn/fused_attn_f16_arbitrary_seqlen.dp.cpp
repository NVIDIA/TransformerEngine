...
void fused_attn_arbitrary_seqlen_fwd_impl(
    ...
    NVTE_Mask_Type mask_type, void *devPtrQ, void *devPtrK, void *devPtrV,
    ...
    void *devPtrCuSeqlensKV, cudnn_frontend::DataType_t tensorType,
    void *workspace, size_t *workspace_size, dpct::queue_ptr stream,
    ...
    try {
        ...
        auto get_graph = [&](CacheType &cache, const FADescriptor_v1 &descriptor)
            ...
            NVTE_CHECK_CUDNN_FE(
                mha_graph->build_operation_graph(dpct::dnnl::engine_ext));
        ...
        /*
        DPCT1009:230: SYCL uses exceptions to report errors and does not use the
            ...
            stream->parallel_for(
                ...
                [=](sycl::nd_item<3> item_ct1) {
                    cu_seqlens_to_actual_seqlens(
                        ...
                        static_cast<int32_t *>(devActualSeqlenKV), item_ct1);
                });
...
void fused_attn_arbitrary_seqlen_bwd_impl(
    ...
    void *devPtrdO, void *devPtrdBias, void *devPtrDropoutSeed,
    void *devPtrDropoutOffset, void *devPtrCuSeqlensQ, void *devPtrCuSeqlensKV,
    cudnn_frontend::DataType_t tensorType, void *workspace,
    ...
    try {
        ...
        // null streams for sizing the cuDNN workspace.
        /*
        DPCT1009:231: SYCL uses exceptions to report errors and does not use the
        error codes. The original code was commented out and a warning string
        was inserted. You need to rewrite this code.
        */
        NVTE_CHECK_CUDNN(DPCT_CHECK_ERROR(handle.set_queue(stream)));
