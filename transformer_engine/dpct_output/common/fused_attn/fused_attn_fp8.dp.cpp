...
static cudnn_frontend::Tensor createAmax(
  ...
  auto amaxTensor = tensor_create(dpct::library_data_t::real_float,
                                  tensor_name_to_uid[amax_tensor_name],
  ...
  auto reduction_op =
      cudnn_frontend::OperationBuilder(
          /*
          DPCT1007:333: Migration of
          CUDNN_BACKEND_OPERATION_REDUCTION_DESCRIPTOR is not supported.
          */
...
createScale(const cudnn_frontend::Tensor &prevBlockOutputTensor,
            const std::string &scale_tensor_name,
            dpct::library_data_t tensorType, bool isOutputVirtual,
            bool isScaleByValue, std::vector<cudnn_frontend::Operation> *ops,
  ...
  auto scaleTensor = tensor_create(
      dpct::library_data_t::real_float, tensor_name_to_uid[scale_tensor_name],
  ...
  /*
  DPCT1007:334: Migration of CUDNN_POINTWISE_MUL is not supported.
  */
  auto scaleDesc =
      pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_MUL);
...
createScale(const cudnn_frontend::Tensor &prevBlockOutputTensor,
  ...
  // Define the scale descriptor
  /*
  DPCT1007:335: Migration of CUDNN_POINTWISE_MUL is not supported.
  */
  auto scaleDesc =
      pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_MUL);
...
static cudnn_frontend::Tensor
createScaleWithOffset(const cudnn_frontend::Tensor &prevBlockOutputTensor,
                      const std::string &scale_tensor_name,
                      NVTE_QKV_Layout layout, dpct::library_data_t tensorType,
  ...
  dpct::library_data_t outputDataType =
      isOutputVirtual ? dpct::library_data_t::real_float : tensorType;
  int64_t outputUID = isOutputVirtual ?
  ...
  // Define the scale descriptor
  /*
  DPCT1007:336: Migration of CUDNN_POINTWISE_MUL is not supported.
  */
  auto scaleDesc =
      pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_MUL);
...
static cudnn_frontend::Tensor createSoftmaxForward(
  ...
  /*
  DPCT1007:338: Migration of CUDNN_POINTWISE_SUB is not supported.
  */
  auto subtractDesc =
      pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_SUB);
  ...
  /*
  DPCT1007:339: Migration of CUDNN_POINTWISE_EXP is not supported.
  */
  auto exponentDesc =
      pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_EXP);
  ...
  /*
  DPCT1007:341: Migration of CUDNN_POINTWISE_RECIPROCAL is not supported.
  */
  auto reciprocalDesc = pw_desc_create(dpct::library_data_t::real_float,
  ...
  /*
  DPCT1007:342: Migration of CUDNN_POINTWISE_MUL is not supported.
  */
  auto multiplyDesc =
      pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_MUL);
...
static cudnn_frontend::Tensor createDropoutForward(
  ...
  auto dropoutMaskTensor = tensor_create(
      dpct::library_data_t::real_float, tensor_name_to_uid["VIRTUAL"] + 250,
      afterBMM1_dim, afterBMM1_stride, true, false); // is virtual
  auto dropoutSeedTensor = tensor_create(
      /*
      DPCT1007:343: Migration of CUDNN_DATA_INT64 is not supported.
      */
      CUDNN_DATA_INT64, tensor_name_to_uid["DROPOUT_SEED"], scale_dim,
      scale_stride, false, false); // is by value
  auto dropoutOffsetTensor = tensor_create(
      /*
      DPCT1007:344: Migration of CUDNN_DATA_INT64 is not supported.
      */
      CUDNN_DATA_INT64, tensor_name_to_uid["DROPOUT_OFFSET"], scale_dim,
      scale_stride, false, false); // is by value
  ...
  auto scaleDropoutTensor = tensor_create(
      dpct::library_data_t::real_float, tensor_name_to_uid["DROPOUT_SCALE"],
      scale_dim, scale_stride, false, true); // is by value
  // After Scale
  auto afterDropout_before_quan_S = tensor_create(
      dpct::library_data_t::real_float, tensor_name_to_uid["VIRTUAL"] + 202,
      afterBMM1_dim, afterBMM1_stride, true, false); // is virtual

  // Define the reduction descriptor
  auto rngDesc = cudnn_frontend::RngDescBuilder()
                     /*
                     DPCT1007:345: Migration of CUDNN_RNG_DISTRIBUTION_BERNOULLI
                     is not supported.
                     */
  ...
  // Create a rng Node
  /*
  DPCT1007:346: Migration of CUDNN_BACKEND_OPERATION_RNG_DESCRIPTOR is not
  supported.
  */
  auto rng_op =
  ...
  /*
  DPCT1007:347: Migration of CUDNN_POINTWISE_MUL is not supported.
  */
  auto maskMulDesc =
      pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_MUL);
  ...
  /*
  DPCT1007:348: Migration of CUDNN_POINTWISE_MUL is not supported.
  */
  auto scaleMulDesc =
      pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_MUL);
...
static cudnn_frontend::Tensor createDropoutBackward(
  ...
  auto dropoutSeedTensor = tensor_create(
      /*
      DPCT1007:349: Migration of CUDNN_DATA_INT64 is not supported.
      */
      CUDNN_DATA_INT64, tensor_name_to_uid["DROPOUT_SEED"], scale_dim,
      scale_stride, false, false); // is by value
  auto dropoutOffsetTensor = tensor_create(
      /*
      DPCT1007:350: Migration of CUDNN_DATA_INT64 is not supported.
      */
      CUDNN_DATA_INT64, tensor_name_to_uid["DROPOUT_OFFSET"], scale_dim,
      scale_stride, false, false); // is by value
  ...
  auto rngDesc = cudnn_frontend::RngDescBuilder()
                     /*
                     DPCT1007:351: Migration of CUDNN_RNG_DISTRIBUTION_BERNOULLI
                     is not supported.
                     */
                     .setRngDistribution(CUDNN_RNG_DISTRIBUTION_BERNOULLI)
                     .setBernoulliDistProbability(1.0 - probability)
  ...
  // Create a rng Node
  /*
  DPCT1007:352: Migration of CUDNN_BACKEND_OPERATION_RNG_DESCRIPTOR is not
  supported.
  */
  auto rng_op =
      cudnn_frontend::OperationBuilder(CUDNN_BACKEND_OPERATION_RNG_DESCRIPTOR)
  ...
  // Define the multiply mask descriptor
  /*
  DPCT1007:353: Migration of CUDNN_POINTWISE_MUL is not supported.
  */
  auto maskMulDesc =
      pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_MUL);
  ...
  // Define the multiply scale descriptor
  /*
  DPCT1007:354: Migration of CUDNN_POINTWISE_MUL is not supported.
  */
  auto scaleMulDesc =
      pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_MUL);
...
static cudnn_frontend::Tensor createSoftmaxBackward(
  ...
  cudnn_frontend::throw_if(
      ops->size() == 0,
      "Softmax backward constructed incorrectly as the first one", 2000);
  ...
  auto ZInvTensor = tensor_create(dpct::library_data_t::real_float,
                                  tensor_name_to_uid["Z_INV"], M_Z_dim,
                                  M_Z_stride, false, false); // not virtual
  auto dxAfterSubtractionTensor = tensor_create(
      dpct::library_data_t::real_float, tensor_name_to_uid["VIRTUAL"] + 252,
      dx_dim, dx_stride, true, false); // is virtual
  auto dxAfterExponentiation = tensor_create(
      dpct::library_data_t::real_float, tensor_name_to_uid["VIRTUAL"] + 253,
      dx_dim, dx_stride, true, false); // is virtual
  auto dxBeforeDropout_QKt_Tensor = tensor_create(
      dpct::library_data_t::real_float, tensor_name_to_uid["VIRTUAL"] + 254,
      dx_dim, dx_stride, true, false); // is virtual

  // Creating all ops
  // sub (dy - M)
  /*
  DPCT1007:355: Migration of CUDNN_POINTWISE_SUB is not supported.
  */
  auto subtractionDesc =
      pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_SUB);
  ...
  // Define the exponent descriptor
  /*
  DPCT1007:356: Migration of CUDNN_POINTWISE_EXP is not supported.
  */
  auto exponentDesc =
      pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_EXP);
  ...
  // Define the pw multiply descriptor
  /*
  DPCT1007:357: Migration of CUDNN_POINTWISE_MUL is not supported.
  */
  auto multiplyDesc =
      pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_MUL);
...
createQKBMM(int64_t b, int64_t h, int64_t s_q, int64_t s_kv, int64_t d,
  ...
  // First GEMM output
  auto afterQKTensor = tensor_create(dpct::library_data_t::real_float,
                                     tensor_name_to_uid["VIRTUAL"] + 1, s_dim,
  ...
  auto reshape_op =
      cudnn_frontend::OperationBuilder(
          /*
          DPCT1007:358: Migration of CUDNN_BACKEND_OPERATION_RESHAPE_DESCRIPTOR
          is not supported.
          */
  ...
  auto matmulOp =
      cudnn_frontend::OperationBuilder(
          /*
          DPCT1007:359: Migration of CUDNN_BACKEND_OPERATION_MATMUL_DESCRIPTOR
          is not supported.
          */
...
createSVBMM(int64_t b, int64_t h, int64_t s_q, int64_t s_kv, int64_t d,
  ...
  auto matmulOp =
      cudnn_frontend::OperationBuilder(
          /*
          DPCT1007:360: Migration of CUDNN_BACKEND_OPERATION_MATMUL_DESCRIPTOR
          is not supported.
          */
          CUDNN_BACKEND_OPERATION_MATMUL_DESCRIPTOR)
...
static cudnn_frontend::Tensor
createSdOBMM(int64_t b, int64_t h, int64_t s_q, int64_t s_kv, int64_t d,
  ...
  auto dVTensor_before_dequan_S = tensor_create(
      dpct::library_data_t::real_float, tensor_name_to_uid["VIRTUAL"] + 500,
      v_dim, v_stride, true, false); // is virtual

  // Create reshape node for softmax -> softmax.T
  auto reshape_op =
      cudnn_frontend::OperationBuilder(
          /*
          DPCT1007:361: Migration of CUDNN_BACKEND_OPERATION_RESHAPE_DESCRIPTOR
          is not supported.
          */
          CUDNN_BACKEND_OPERATION_RESHAPE_DESCRIPTOR)
  ...
  auto matmulOp =
      cudnn_frontend::OperationBuilder(
          /*
          DPCT1007:362: Migration of CUDNN_BACKEND_OPERATION_MATMUL_DESCRIPTOR
          is not supported.
          */
          CUDNN_BACKEND_OPERATION_MATMUL_DESCRIPTOR)
...
static cudnn_frontend::Tensor
createdOVBMM(int64_t b, int64_t h, int64_t s_q, int64_t s_kv, int64_t d,
             NVTE_QKV_Layout layout, dpct::library_data_t tensorType,
             std::vector<cudnn_frontend::Operation> *ops,
             const cudnn_frontend::Tensor &dOTensor,
             const cudnn_frontend::Tensor &mnkOverride,
  ...
  auto afterdOVTensor = tensor_create(
      dpct::library_data_t::real_float, tensor_name_to_uid["VIRTUAL"] + 600,
  ...
  auto reshape_op =
      cudnn_frontend::OperationBuilder(
          /*
          DPCT1007:363: Migration of CUDNN_BACKEND_OPERATION_RESHAPE_DESCRIPTOR
          is not supported.
          */
          CUDNN_BACKEND_OPERATION_RESHAPE_DESCRIPTOR)
          .setxDesc(vTensor)
  ...
  auto matmulOp =
      cudnn_frontend::OperationBuilder(
          /*
          DPCT1007:364: Migration of CUDNN_BACKEND_OPERATION_MATMUL_DESCRIPTOR
          is not supported.
          */
          CUDNN_BACKEND_OPERATION_MATMUL_DESCRIPTOR)
...
static cudnn_frontend::Tensor createdOAndORowReductionChain(
  ...
  auto O_dO_after_pointwise_multiply = tensor_create(
      dpct::library_data_t::real_float, tensor_name_to_uid["VIRTUAL"] + 700,
      o_dim, o_stride, true, false); // is virtual
  auto O_dO_after_dropout_scale = tensor_create(
      dpct::library_data_t::real_float, tensor_name_to_uid["VIRTUAL"] + 701,
      o_dim, o_stride, true, false); // is virtual
  auto O_dO_after_rowsum = tensor_create(
      dpct::library_data_t::real_float, tensor_name_to_uid["VIRTUAL"] + 702,
      o_dim_row_sum, o_dim_row_sum_stride, true, false); // is virtual

  // Define the pw multiply descriptor
  /*
  DPCT1007:365: Migration of CUDNN_POINTWISE_MUL is not supported.
  */
  auto multiplyDesc =
      pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_MUL);
...
static cudnn_frontend::Tensor createBiasSubtractionSoftmaxMulChain(
  ...
  auto dS_minus_O_dO = tensor_create(dpct::library_data_t::real_float,
                                     tensor_name_to_uid["VIRTUAL"] + 800, o_dim,
                                     o_stride, true, false); // is virtual
  auto AfterAttnScale_before_dS = tensor_create(
      dpct::library_data_t::real_float, tensor_name_to_uid["VIRTUAL"] + 801,
      o_dim, o_stride, true, false); // is virtual
  auto S_mul_dS_minus_O_dO = tensor_create(
      dpct::library_data_t::real_float, tensor_name_to_uid["VIRTUAL"] + 802,
      o_dim, o_stride, true, false); // is virtual

  // Define the pw subtraction descriptor
  /*
  DPCT1007:367: Migration of CUDNN_POINTWISE_SUB is not supported.
  */
  auto subDesc =
      pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_SUB);
  ...
  /*
  DPCT1007:368: Migration of CUDNN_POINTWISE_MUL is not supported.
  */
  auto multiplyDesc =
      pw_desc_create(dpct::library_data_t::real_float, CUDNN_POINTWISE_MUL);
...
static cudnn_frontend::Tensor createdSKBMM(
  ...
  auto After_dS_K = tensor_create(
      dpct::library_data_t::real_float, tensor_name_to_uid["VIRTUAL"] + 875,
  ...
  auto matmulOp =
      cudnn_frontend::OperationBuilder(
          /*
          DPCT1007:369: Migration of CUDNN_BACKEND_OPERATION_MATMUL_DESCRIPTOR
          is not supported.
          */
          CUDNN_BACKEND_OPERATION_MATMUL_DESCRIPTOR)
...
static cudnn_frontend::Tensor createdSQBMM(
  ...
  auto dSTransposeTensor = tensor_create(
      /*
      DPCT1007:370: Migration of CUDNN_DATA_FP8_E5M2 is not supported.
      */
  ...
  auto After_dSTranspose_Q = tensor_create(
      dpct::library_data_t::real_float, tensor_name_to_uid["VIRTUAL"] + 651,
      after_dSTranspose_Q_dim, after_dSTranspose_Q_stride, true,
      false); // is virtual
  ...
  auto reshape_op =
      cudnn_frontend::OperationBuilder(
          /*
          DPCT1007:371: Migration of CUDNN_BACKEND_OPERATION_RESHAPE_DESCRIPTOR
          is not supported.
          */
          CUDNN_BACKEND_OPERATION_RESHAPE_DESCRIPTOR)
          .setxDesc(dSTensor)
  ...
  auto matmulOp =
      cudnn_frontend::OperationBuilder(
          /*
          DPCT1007:372: Migration of CUDNN_BACKEND_OPERATION_MATMUL_DESCRIPTOR
          is not supported.
          */
          CUDNN_BACKEND_OPERATION_MATMUL_DESCRIPTOR)
...
void fused_attn_fp8_fwd_impl(
    int64_t b, int64_t h, int64_t s_q, int64_t s_kv, int64_t d, bool isTraining,
    float attnScale, float dropoutProbability, NVTE_QKV_Layout layout,
    void *devPtrQ, void *devPtrK, void *devPtrV, void *devPtrM,
    void *devPtrZInv, void *devPtrO, void *devPtrDescaleQ, void *devPtrDescaleK,
    void *devPtrDescaleV, void *devPtrDescaleS, void *devPtrScaleS,
    void *devPtrScaleO, void *devPtrAmaxO, void *devPtrAmaxS,
    void *devPtrcuSeqlensQ, void *devPtrcuSeqlensKV, void *devPtrDropoutSeed,
    void *devPtrDropoutOffset, dpct::library_data_t tensorType,
    void *workspace_ptr, size_t *workspace_size, dpct::queue_ptr stream,
  ...
  try {
      ...
      auto get_plan = [&](CacheType &cache, const FADescriptor &descriptor) {
          ...
          cudnn_frontend::throw_if(
              dropoutProbability != 0.0f && !isTraining,
              "Dropout probability should be 0.0f for inference mode", 2000);
          cudnn_frontend::throw_if(dropoutProbability == 1.0f,
                                   "Dropout probability cannot be 1.0", 2000);

          int64_t raggedDim[4] =  {b + 1, 1, 1, 1};
          int64_t raggedStride[4] = {1, 1, 1, 1};
          // Create offset tensors
          auto QKVOffsetTensor =
              tensor_create(dpct::library_data_t::real_int32,
                            tensor_name_to_uid["QKV_RAGGED"], raggedDim,
                            raggedStride, false, false);
          auto ORaggedOffsetTensor = tensor_create(
              dpct::library_data_t::real_int32, tensor_name_to_uid["O_RAGGED"],
              raggedDim, raggedStride, false, false);

          int64_t seqlen_dim[4] =  {b, 1, 1, 1};
          int64_t seqlen_stride[4] = {1, 1, 1, 1};
          // Create override tensors
          auto seqlenMNKTensor =
              tensor_create(dpct::library_data_t::real_int32,
                            tensor_name_to_uid["MNK_OVERRIDE"], seqlen_dim,
          ...
          auto qTensor = tensor_create_with_offset(
              dpct::library_data_t, tensor_name_to_uid["Q"], q_dim, q_stride,
          ...
          auto AfterAttnScale_before_dequan_Q_tensor = createScale(
              ...
              dpct::library_data_t::real_float, // output tensor type
      ...
      /*
      DPCT1009:373: SYCL uses exceptions to report errors and does not use the
      error codes. The original code was commented out and a warning string was
      inserted. You need to rewrite this code.
      */
      NVTE_CHECK_CUDNN(DPCT_CHECK_ERROR(handle_.set_queue(stream)));
      ...
      sycl::range<3> blockDims(1, 1, 128);
      sycl::range<3> gridDims(1, 1, (b + blockDims[2]) / blockDims[2]);
      /*
      ...
      */
        stream->parallel_for(
            sycl::nd_range<3>(gridDims * blockDims, blockDims),
      ...
      auto variantPack  = cudnn_frontend::VariantPackBuilder()
                             ...
                             .build();
      /*
      DPCT1007:374: Migration of cudnnBackendExecute is not supported.
      */
      dpct::err1 status = cudnnBackendExecute(handle_, plan.get_raw_desc(),
      ...
      /*
      DPCT1009:375: SYCL uses exceptions to report errors and does not use the
      error codes. The original code was commented out and a warning string was
      inserted. You need to rewrite this code.
      */
      NVTE_CHECK_CUDA(DPCT_CHECK_ERROR(dpct::get_device_info(
          prop, dpct::dev_mgr::instance().get_device(0))));
      ...
      */
      if (!((prop.get_major_version() == 9 && prop.get_minor_version() == 0 &&
             CUDNN_VERSION >= 8900)) &&
...
void fused_attn_fp8_bwd_impl(
    ...
    float dropoutProbability, NVTE_QKV_Layout layout, void *devPtrQ,
    void *devPtrK, void *devPtrV, void *devPtrM, void *devPtrZInv,
    void *devPtrO, void *devPtrdO, void *devPtrdQ, void *devPtrdK,
    void *devPtrdV, void *devPtrDescaleQ, void *devPtrDescaleK,
    void *devPtrDescaleV, void *devPtrDescaleO, void *devPtrDescaledO,
    void *devPtrDescaleS, void *devPtrDescaledS, void *devPtrScaleS,
    void *devPtrScaledS, void *devPtrScaledQ, void *devPtrScaledK,
    void *devPtrScaledV, void *devPtrAmaxdS, void *devPtrAmaxdQ,
    void *devPtrAmaxdK, void *devPtrAmaxdV, void *devPtrcuSeqlensQ,
    void *devPtrcuSeqlensKV, void *devPtrDropoutSeed, void *devPtrDropoutOffset,
    dpct::library_data_t tensorType, void *workspace_ptr,
    size_t *workspace_size, dpct::queue_ptr stream,
    dpct::dnnl::engine_ext handle_) {
  try {
      FADescriptor descriptor{
              b, h, s_q, s_kv, d,
      ...
      auto get_plan = [&](CacheType &cache, const FADescriptor &descriptor) {
          ...
          auto attnScaleTensor = tensor_create(
              dpct::library_data_t::real_float, tensor_name_to_uid["AttnScale"],
              scale_dim, scale_stride, false, true); // is by value

          // Create descale Q K dO dS global tensors since they are used in multiple places
          auto descaleQTensor = tensor_create(
              dpct::library_data_t::real_float, tensor_name_to_uid["descaleQ"],
              scale_dim, scale_stride, false, false);
          auto descaleKTensor = tensor_create(
              dpct::library_data_t::real_float, tensor_name_to_uid["descaleK"],
              scale_dim, scale_stride, false, false);
          auto descaledOTensor = tensor_create(
              dpct::library_data_t::real_float, tensor_name_to_uid["descaledO"],
              scale_dim, scale_stride, false, false);
          auto descaledSTensor = tensor_create(
              dpct::library_data_t::real_float, tensor_name_to_uid["descaledS"],
              scale_dim, scale_stride, false, false);
          ...
          auto dOTensor = tensor_create_with_offset(
              /*
              DPCT1007:377: Migration of CUDNN_DATA_FP8_E5M2 is not supported.
              */
              CUDNN_DATA_FP8_E5M2, tensor_name_to_uid["dO"], O_dim, O_stride,
          ...
          auto dropoutMaskTensor =
              tensor_create(dpct::library_data_t::real_float,
                            tensor_name_to_uid["VIRTUAL"] + 200, afterBMM1_dim,
          ...
          auto dVTensor = createScaleWithOffset(
              ...
              layout,                  // qkv layout
              /*
              DPCT1007:378: Migration of CUDNN_DATA_FP8_E5M2 is not supported.
              */
          ...
          auto beforeDropoutScale_dOVt_Tensor =
              tensor_create(dpct::library_data_t::real_float,
                            tensor_name_to_uid["VIRTUAL"] + 350, afterBMM1_dim,
                            afterBMM1_stride, true, false); // is virtual
          // After dropout mask and scale
          auto dS_after_dropout =
              tensor_create(dpct::library_data_t::real_float,
                            tensor_name_to_uid["VIRTUAL"] + 351, afterBMM1_dim,
                            afterBMM1_stride, true, false); // is virtual

          // Define the multiply mask descriptor
          /*
          DPCT1007:379: Migration of CUDNN_POINTWISE_MUL is not supported.
          */
          auto mulDesc = pw_desc_create(dpct::library_data_t::real_float,
                                        CUDNN_POINTWISE_MUL);
          ...
          // O * dequant_O
          auto O_after_dequan_Tensor = createScale(
              OTensor,                          // input tensor
          ...
          // dO * dequant_dO
          auto dO_after_dequan_Tensor = createScale(
              dOTensor,                         // input tensor
              descaledOTensor,                  // scale tensor
              dpct::library_data_t::real_float, // output tensor type
              true,                             // output is virtual
              false,                            // scale is by value
          ...
          auto S_mul_dS_minus_O_dO_after_quan_dS = createScale(
              ...
              /*
              DPCT1007:380: Migration of CUDNN_DATA_FP8_E5M2 is not supported.
              */
              CUDNN_DATA_FP8_E5M2, // output tensor type
              true,                // output is virtual
              false,               // scale is by value
          ...
          auto dQ = createScaleWithOffset(
              ...
              layout,                    // qkv layout
              /*
              DPCT1007:381: Migration of CUDNN_DATA_FP8_E5M2 is not supported.
              */
              CUDNN_DATA_FP8_E5M2, // output tensor type
              false,               // output not virtual
              false,               // scale is by value
          ...
          auto dK = createScaleWithOffset(
              ...
              layout,                             // qkv layout
              /*
              DPCT1007:382: Migration of CUDNN_DATA_FP8_E5M2 is not supported.
              */
              CUDNN_DATA_FP8_E5M2, // output tensor type
              false,               // output not virtual
              false,               // scale is by value
      ...
      // null streams for sizing the cuDNN workspace.
      /*
      DPCT1009:383: SYCL uses exceptions to report errors and does not use the
      error codes. The original code was commented out and a warning string was
      inserted. You need to rewrite this code.
      */
      NVTE_CHECK_CUDNN(DPCT_CHECK_ERROR(handle_.set_queue(stream)));
      ...
      */
      ...
      auto variantPack  = cudnn_frontend::VariantPackBuilder()
                             ...
                             .build();
      /*
      DPCT1007:384: Migration of cudnnBackendExecute is not supported.
      */
      dpct::err1 status = cudnnBackendExecute(handle_, plan.get_raw_desc(),
                                              variantPack.get_raw_desc());
      ...
      dpct::device_info prop;
      /*
      DPCT1009:385: SYCL uses exceptions to report errors and does not use the
      error codes. The original code was commented out and a warning string was
      inserted. You need to rewrite this code.
      */
      NVTE_CHECK_CUDA(DPCT_CHECK_ERROR(dpct::get_device_info(
...
void fused_attn_fp8_fwd_qkvpacked(
    size_t b, size_t h, size_t max_seqlen, size_t d, bool is_training,
    ...
    const Tensor *rng_state, Tensor *workspace, dpct::queue_ptr stream,
...
void fused_attn_fp8_bwd_qkvpacked(
    size_t b, size_t h, size_t max_seqlen, size_t d, float attn_scale,
    float p_dropout, NVTE_QKV_Layout qkv_layout, const Tensor *input_QKV,
    ...
    const Tensor *output_dQKV, const Tensor *cu_seqlens,
    const Tensor *rng_state, Tensor *workspace, dpct::queue_ptr stream,
    dpct::dnnl::engine_ext handle) {
  using namespace transformer_engine;
  // QKV shape is [total_seqs, 3, h, d]
...
void fused_attn_fp8_fwd(size_t b, size_t h, size_t max_seqlen_q,
                        size_t max_seqlen_kv, size_t d, bool is_training,
                        float attn_scale, float p_dropout,
                        NVTE_QKV_Layout qkv_layout, const Tensor *input_Q,
                        ...
                        dpct::queue_ptr stream, dpct::dnnl::engine_ext handle) {
  using namespace transformer_engine;
...
void fused_attn_fp8_bwd(size_t b, size_t h, size_t max_seqlen_q,
                        size_t max_seqlen_kv, size_t d, float attn_scale,
                        float p_dropout, NVTE_QKV_Layout qkv_layout,
                        const Tensor *input_Q, const Tensor *input_K,
                        const Tensor *input_V, const Tensor *input_O,
                        const Tensor *input_dO, const Tensor *input_M,
                        const Tensor *input_ZInv, const Tensor *input_S,
                        Tensor *input_output_dP, const Tensor *output_dQ,
