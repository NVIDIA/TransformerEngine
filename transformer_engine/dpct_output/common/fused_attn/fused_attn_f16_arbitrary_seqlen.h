...
void fused_attn_arbitrary_seqlen_fwd_qkvpacked(
    size_t batch, size_t num_attn_heads, size_t max_seqlen, size_t head_size,
...
void fused_attn_arbitrary_seqlen_bwd_qkvpacked(
    ...
    const Tensor *cu_seqlens, const Tensor *rng_state, Tensor *workspace,
...
void fused_attn_arbitrary_seqlen_bwd_kvpacked(
    ...
    const Tensor *input_KV, const Tensor *input_O, const Tensor *input_dO,
