...
tensor_create_with_offset(dpct::library_data_t type, int64_t id,
                          int64_t const *dim, int64_t const *stride,
                          bool is_virtual, bool is_value,
...
struct FADescriptor {
  ...
  dpct::library_data_t tensor_type;
...
class cudnnExecutionPlanManager {
 public:
    ...
    dpct::dnnl::engine_ext GetCudnnHandle() {
 ...
 private:
    dpct::dnnl::engine_ext handle_ = nullptr;
};
}  // namespace transformer_engine
