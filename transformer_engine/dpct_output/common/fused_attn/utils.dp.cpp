...
cudnn_frontend::Tensor tensor_create(dpct::library_data_t type, int64_t id,
...
cudnn_frontend::Tensor tensor_create_with_offset(
    dpct::library_data_t type, int64_t id, int64_t const *dim,
...
cudnn_frontend::PointWiseDesc pw_desc_create(dpct::library_data_t type,
...
cudnn_frontend::Operation unary_pw_op_create(
  ...
  auto pw_op_created =
      cudnn_frontend::OperationBuilder(
          /*
          DPCT1007:531: Migration of
          CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
          */
...
SYCL_EXTERNAL void cu_seqlens_to_offsets(size_t b, size_t h, size_t d,
                                         int32_t *cu_seqlens_q,
                                         int32_t *actual_seqlens_q,
                                         int32_t *qkv_ragged_offset,
                                         int32_t *o_ragged_offset,
                                         const sycl::nd_item<3> &item_ct1) {
  size_t tid = item_ct1.get_group(2) * item_ct1.get_local_range(2) +
...
SYCL_EXTERNAL void
cu_seqlens_to_actual_seqlens(size_t b, int32_t const *const q_cu_seqlens,
...
// get cuDNN data type
dpct::library_data_t get_cudnn_dtype(const transformer_engine::DType t) {
  using namespace transformer_engine;
  switch (t) {
    case DType::kInt32:
    ...
    case DType::kInt64:
      /*
      DPCT1007:534: Migration of CUDNN_DATA_INT64 is not supported.
      */
    ...
    case DType::kFloat8E4M3:
      /*
      DPCT1007:535: Migration of CUDNN_DATA_FP8_E4M3 is not supported.
      */
      return CUDNN_DATA_FP8_E4M3;
    case DType::kFloat8E5M2:
      /*
      DPCT1007:536: Migration of CUDNN_DATA_FP8_E5M2 is not supported.
      */
