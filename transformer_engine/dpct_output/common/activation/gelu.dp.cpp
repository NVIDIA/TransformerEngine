...
void gelu(const Tensor &input, Tensor *output, dpct::queue_ptr stream) {
...
void dgelu(const Tensor &grad, const Tensor &input, Tensor *output,
...
void geglu(const Tensor &input, Tensor *output, dpct::queue_ptr stream) {
...
void dgeglu(const Tensor &grad, const Tensor &input, Tensor *output,
            dpct::queue_ptr stream) {
...
void qgelu(const Tensor &input, Tensor *output, dpct::queue_ptr stream) {
...
void dqgelu(const Tensor &grad, const Tensor &input, Tensor *output,
            dpct::queue_ptr stream) {
...
void nvte_gelu(const NVTETensor input, NVTETensor output,
               dpct::queue_ptr stream) {
...
void nvte_geglu(const NVTETensor input, NVTETensor output,
                dpct::queue_ptr stream) {
...
void nvte_dgeglu(const NVTETensor grad, const NVTETensor input,
                 NVTETensor output, dpct::queue_ptr stream) {
...
void nvte_qgelu(const NVTETensor input, NVTETensor output,
                dpct::queue_ptr stream) {
...
void nvte_dqgelu(const NVTETensor grad, const NVTETensor input,
                 NVTETensor output, dpct::queue_ptr stream) {
