...
void relu(const Tensor &input, Tensor *output, dpct::queue_ptr stream) {
...
void drelu(const Tensor &grad, const Tensor &input, Tensor *output,
...
void reglu(const Tensor &input, Tensor *output, dpct::queue_ptr stream) {
...
void dreglu(const Tensor &grad, const Tensor &input, Tensor *output,
            dpct::queue_ptr stream) {
