...
void launch_tuned_(LaunchParams<FwdParams> &launch_params,
    ...
    if ( configure_params ) {
        int ctas_per_sm;
        /*
        DPCT1007:461: Migration of cudaOccupancyMaxActiveBlocksPerMultiprocessor
        is not supported.
        */
    ...
    if ( Kernel_traits::SMEM_BYTES_FWD >= 48 * 1024 ) {
        /*
        DPCT1009:460: SYCL uses exceptions to report errors and does not use the
        error codes. The original code was commented out and a warning string
        was inserted. You need to rewrite this code.
        */
        /*
        DPCT1027:462: The call to cudaFuncSetAttribute was replaced with 0
    ...
    if ( ctas_per_row == 1 ) {
        ...
        */
        ...
        /*
        DPCT1007:51: Migration of cudaLaunchCooperativeKernel is not supported.
        */
...
void launch_general_(LaunchParams<FwdParams> &launch_params, const bool configure_params) {  // NOLINT(*)
    ...
    if ( configure_params ) {
        int ctas_per_sm;
        /*
        DPCT1007:463: Migration of cudaOccupancyMaxActiveBlocksPerMultiprocessor
        is not supported.
        */
        dpct::err0 status_ = cudaOccupancyMaxActiveBlocksPerMultiprocessor(
    ...
    if ( ctas_per_row == 1 ) {
        ...
        */
        ...
        void *params_ = reinterpret_cast<void *>(&launch_params.params);
        /*
        DPCT1007:53: Migration of cudaLaunchCooperativeKernel is not supported.
        */
