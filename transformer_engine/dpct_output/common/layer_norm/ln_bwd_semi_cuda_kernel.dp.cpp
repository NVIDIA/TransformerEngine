...
void launch_tuned_(LaunchParams<BwdParams> &launch_params,
    ...
    if ( configure_params ) {
        int ctas_per_sm;
        /*
        DPCT1007:528: Migration of cudaOccupancyMaxActiveBlocksPerMultiprocessor
        is not supported.
        */
    ...
    if ( Kernel_traits::SMEM_BYTES >= 48 * 1024 ) {
        /*
        DPCT1009:527: SYCL uses exceptions to report errors and does not use the
        error codes. The original code was commented out and a warning string
        was inserted. You need to rewrite this code.
        */
        /*
        DPCT1027:529: The call to cudaFuncSetAttribute was replaced with 0
    ...
    if ( ctas_per_row == 1 ) {
        ...
        */
        ...
        /*
        DPCT1007:180: Migration of cudaLaunchCooperativeKernel is not supported.
        */
...
void launch_general_(LaunchParams<BwdParams> &launch_params, const bool configure_params) {  // NOLINT(*)
    ...
    if ( configure_params ) {
        int ctas_per_sm;
        /*
        DPCT1007:530: Migration of cudaOccupancyMaxActiveBlocksPerMultiprocessor
        is not supported.
        */
    ...
    if ( ctas_per_row == 1 ) {
        ...
        */
        ...
        void *params_ = reinterpret_cast<void *>(&launch_params.params);
        /*
        DPCT1007:183: Migration of cudaLaunchCooperativeKernel is not supported.
        */
        cudaLaunchCooperativeKernel(reinterpret_cast<void *>(kernel), grid,
                                    block, reinterpret_cast<void **>(&params_),
                                    0, stream);
