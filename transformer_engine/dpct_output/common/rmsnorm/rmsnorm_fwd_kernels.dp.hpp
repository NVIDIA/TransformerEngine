...
rmsnorm_fwd_tuned_kernel exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
void rmsnorm_fwd_tuned_kernel(FwdParams params,
...
#pragma unroll
        ...
        /*
        DPCT1084:8: The function call "Stats::compute" has multiple migration
        ...
        */
        ...
        compute_t rs = sycl::rsqrt(rn * m2 + mu * mu + params.epsilon);
...
rmsnorm_fwd_general_kernel exceeds 128 bytes and may cause high register
pressure. Consult with your hardware vendor to find the total register size
available and adjust the code, or use smaller sub-group size to avoid high
register pressure.
*/
void rmsnorm_fwd_general_kernel(FwdParams params,
