...
void nvte_get_quantization_config_attribute(NVTEQuantizationConfig config,
  ...
  switch (attr) {
    ...
    case kNVTEQuantizationConfigUseFastMath:
      ...
      break;
    case kNVTEQuantizationConfigNVFP4Rowwise1x64LocalEncode:
      bool_to_uint8(config_.nvfp4_rowwise_1x64_local_encode, buf);
      break;
    default:
...
void nvte_set_quantization_config_attribute(NVTEQuantizationConfig config,
  ...
  switch (attr) {
    ...
    case kNVTEQuantizationConfigUseFastMath:
      ...
      break;
    case kNVTEQuantizationConfigNVFP4Rowwise1x64LocalEncode:
      uint8_to_bool(buf, config_.nvfp4_rowwise_1x64_local_encode);
      break;
    default:
      NVTE_ERROR("Unsupported NVTEQuantizationConfigAttribute (got ", static_cast<int>(attr), ")");
  }
