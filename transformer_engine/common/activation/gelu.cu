...
void nvte_gelu(const NVTETensor input,
  ...
  act_lu<fp32, Empty, gelu<fp32, fp32>>(*reinterpret_cast<const Tensor*>(input),
...
void nvte_dgelu(const NVTETensor grad,
  ...
  using namespace transformer_engine;
  dact_lu<fp32, Empty, dgelu<fp32, fp32>>(*reinterpret_cast<const Tensor*>(grad),
...
void nvte_geglu(const NVTETensor input,
  ...
  using namespace transformer_engine;
  gated_act_lu<fp32, Empty, gelu<fp32, fp32>>(*reinterpret_cast<const Tensor*>(input),
                                              reinterpret_cast<Tensor*>(output),
                                              stream);
}
...
void nvte_dgeglu(const NVTETensor grad,
  ...
  using namespace transformer_engine;
  dgated_act_lu<fp32, Empty, gelu<fp32, fp32>, dgelu<fp32, fp32>>(
...
void nvte_qgelu(const NVTETensor input,
  ...
  using namespace transformer_engine;
  act_lu<fp32, Empty, qgelu<fp32, fp32>>(*reinterpret_cast<const Tensor*>(input),
                                         reinterpret_cast<Tensor*>(output),
                                         stream);
}
...
void nvte_dqgelu(const NVTETensor grad,
  ...
  using namespace transformer_engine;
  dact_lu<fp32, Empty, dqgelu<fp32, fp32>>(*reinterpret_cast<const Tensor*>(grad),
                                                *reinterpret_cast<const Tensor*>(input),
                                                reinterpret_cast<Tensor*>(output),
                                                stream);
}
