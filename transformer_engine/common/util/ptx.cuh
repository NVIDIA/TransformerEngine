...
#define ARCH_BLACKWELL_FAMILY ARCH_SPECIFIC(ptx::Family<100>, ptx::Family<110>, ptx::Family<120>)
#define ARCH_HAS_STOCHASTIC_ROUNDING ARCH_SPECIFIC(ptx::Arch<100>, ptx::Arch<103>)
