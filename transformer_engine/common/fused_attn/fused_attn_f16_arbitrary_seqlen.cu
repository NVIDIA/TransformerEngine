...
void fused_attn_arbitrary_seqlen_fwd_impl(
  ...
  try {
    FADescriptor_v1 descriptor{b,
                               ...
                               layout,
                               bias_type,
                               mask_type, window_size_left, window_size_right, true,
                               tensorType,
                               tensorType};
...
void fused_attn_arbitrary_seqlen_bwd_impl(
    ...
    NVTE_Bias_Type bias_type, NVTE_Mask_Type mask_type, int64_t window_size_left, int64_t window_size_right, bool deterministic, void *devPtrQ, void *devPtrKTranspose,
  ...
  try {
    FADescriptor_v1 descriptor{b,
                               ...
                               layout,
                               bias_type,
                               mask_type, window_size_left, window_size_right, deterministic,
                               tensorType,
                               tensorType};
...
void fused_attn_arbitrary_seqlen_fwd_qkvpacked(
    ...
    NVTE_Mask_Type mask_type, int64_t window_size_left, int64_t window_size_right, const Tensor *input_QKV, const Tensor *input_Bias, Tensor *output_O,
  ...
  fused_attn_arbitrary_seqlen_fwd_impl(
      ...
      is_training, attn_scale, p_dropout, qkv_layout, bias_type, mask_type, window_size_left, window_size_right, devPtrQ, devPtrK,
...
void fused_attn_arbitrary_seqlen_bwd_qkvpacked(
    ...
    float p_dropout, NVTE_QKV_Layout qkv_layout, NVTE_Bias_Type bias_type, NVTE_Mask_Type mask_type, int64_t window_size_left, int64_t window_size_right, bool deterministic,
  ...
  fused_attn_arbitrary_seqlen_bwd_impl(
      batch, num_attn_heads, num_attn_heads, max_seqlen, max_seqlen, head_dim, bias_b, bias_h,
      attn_scale, p_dropout, qkv_layout, bias_type, mask_type, window_size_left, window_size_right, deterministic, devPtrQ, devPtrK, devPtrV, devPtrO,
...
void fused_attn_arbitrary_seqlen_fwd_kvpacked(
    ...
    NVTE_QKV_Layout qkv_layout, NVTE_Bias_Type bias_type, NVTE_Mask_Type mask_type, int64_t window_size_left, int64_t window_size_right,
...
void fused_attn_arbitrary_seqlen_bwd_kvpacked(
    ...
    NVTE_QKV_Layout qkv_layout, NVTE_Bias_Type bias_type, NVTE_Mask_Type mask_type, int64_t window_size_left, int64_t window_size_right, bool deterministic,
...
void fused_attn_arbitrary_seqlen_fwd(size_t batch, size_t num_attn_heads, size_t num_gqa_groups,
                                     ...
                                     NVTE_Mask_Type mask_type, int64_t window_size_left, int64_t window_size_right, const Tensor *input_Q,
