...
struct FADescriptor_v1 {
  ...
  bool operator<(const FADescriptor_v1 &rhs) const {
    return std::tie(b, h, hg, s_q, s_kv, d, bias_b, bias_h, attnScale, isTraining,
                    dropoutProbability, layout, mask_type, window_size_left, window_size_right, bias_type, fwd_tensor_type,
                    bwd_tensor_type) <
           std::tie(rhs.b, rhs.h, rhs.hg, rhs.s_q, rhs.s_kv, rhs.d, rhs.bias_b, rhs.bias_h,
                    ...
                    rhs.mask_type, rhs.window_size_left, rhs.window_size_right, rhs.bias_type, rhs.fwd_tensor_type, rhs.bwd_tensor_type);
  }
};
