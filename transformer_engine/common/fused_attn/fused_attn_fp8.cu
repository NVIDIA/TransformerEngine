...
void fa_fp8_fprop(
            ...
            MHA_Layout layout,
            void* devPtrQKV, void* devPtrM, void* devPtrZInv, void* devPtrO,
            ...
            void* devPtrQKVRaggedOffset, void* devPtrORaggeDOffset,
...
void fa_fp8_bprop(
            ...
            void* devPtrQKV, void* devPtrM, void* devPtrZInv,
            void* devPtrO, void* devPtrdO, void* devPtrdQKV,
            void* devPtrDropoutSeed, void* devPtrDropoutOffset,
            void* devPtrDescaleQ, void* devPtrDescaleK, void* devPtrDescaleV,
            ...
            void* devPtrAmaxdS, void* devPtrAmaxdQ,
            void* devPtrAmaxdK, void* devPtrAmaxdV,
            void* devPtrQKVRaggedOffset, void* devPtrORaggeDOffset,
            void* devPtrMNKOverride,
            cudnnDataType_t tensorType,
            void* workspace_ptr,
  ...
  try {
      ...
      *workspace_size = static_cast<uint64_t>(plan.getWorkspaceSize());
      ...
      void* devPtrQ = reinterpret_cast<void *>(devPtrQKV);
      // k is at an offset of h * d
      void* devPtrK = reinterpret_cast<void *>(
                      reinterpret_cast<int8_t*>(devPtrQKV) + h * d);
      // v is at an offset of 2 * h * d
      void* devPtrV = reinterpret_cast<void *>(
                      reinterpret_cast<int8_t*>(devPtrQKV) + 2 * h * d);

      // dQ points to the top of dQKV
      void* devPtrdQ = reinterpret_cast<void *>(devPtrdQKV);
      // dK is at an offset of h * d
      void* devPtrdK = reinterpret_cast<void *>(
                      reinterpret_cast<int8_t*>(devPtrdQKV) + h * d);
      // dV is at an offset of 2 * h * d
      void* devPtrdV = reinterpret_cast<void *>(
                      reinterpret_cast<int8_t*>(devPtrdQKV) + 2 * h * d);
...
void fused_attn_fwd(
            ...
            Tensor *input_M, Tensor *input_ZInv,
            Tensor *input_S, Tensor *input_O,
            int32_t *QKVRaggedOffset, int32_t *ORaggedOffset,
            int32_t *Seqlens, uint64_t *RngState,
            Tensor *workspace,
            cudaStream_t stream,
...
void fused_attn_bwd(
  ...
  if (((QKV_type == DType::kFloat8E4M3) || (QKV_type == DType::kFloat8E5M2))
    ...
    fused_attn::fa_fp8_bprop(
                    ...
                    devPtrDropoutSeed, devPtrDropoutOffset,
                    devPtrDescaleQ, devPtrDescaleK, devPtrDescaleV,
                    devPtrDescaleO, devPtrDescaledO, devPtrDescaleS,
                    devPtrDescaledS, devPtrScaleS, devPtrScaledS,
                    devPtrScaledQ, devPtrScaledK, devPtrScaledV,
                    devPtrAmaxdS, devPtrAmaxdQ, devPtrAmaxdK, devPtrAmaxdV,
                    devPtrQKVRaggedOffset, devPtrORaggedOffset,
                    devPtrMNKOverride, get_cudnn_dtype(QKV_type),
                    workspace->data.dptr, &workspace_size, stream, handle);
...
void nvte_fused_attn_fwd(
            ...
            NVTETensor M, NVTETensor ZInv,
            NVTETensor S, NVTETensor O,
            int32_t *QKVRaggedOffset, int32_t *ORaggedOffset,
            int32_t *Seqlens, uint64_t *RngState,
