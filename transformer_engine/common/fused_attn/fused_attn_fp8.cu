...
void fused_attn_fp8_bwd_impl_v1(
  ...
  try {
    ...
    cudaDeviceSynchronize();
    printf(
        "CS BWD before: scale_dp %f, descale_dp %f, descale_q %f, descale_k %f, descale_v %f, "
        "descale_o %f, descale_do %f, amax_dp %f, amax_dq %f, amax_dk %f, amax_dv %f\n",
    ...
    cudaDeviceSynchronize();
    printf(
        "CS BWD after: scale_dp %f, descale_dp %f, descale_q %f, descale_k %f, descale_v %f, "
        "descale_o %f, descale_do %f, amax_dp %f, amax_dq %f, amax_dk %f, amax_dv %f\n",
        tmp[0], tmp[1], tmp[2], tmp[3], tmp[4], tmp[5], tmp[6], tmp[7], tmp[8], tmp[9], tmp[10]);
