...
void nvte_fused_attn_fwd(const NVTETensor Q, const NVTETensor K, const NVTETensor V,
                         ...
                         const NVTETensor cu_seqlens_kv_padded, const NVTETensor rng_state,
                         size_t max_seqlen_q, size_t max_seqlen_kv, size_t max_batch_size,
                         size_t max_tokens_q, size_t max_tokens_kv, bool is_training,
                         float attn_scale, float dropout, NVTE_QKV_Layout qkv_layout,
                         NVTE_Bias_Type bias_type, NVTE_Mask_Type attn_mask_type,
  ...
  if (fused_attention_backend == NVTE_Fused_Attn_Backend::NVTE_F16_max512_seqlen) {
    ...
    fused_attn_arbitrary_seqlen_fwd(
        b, h_q, h_kv, max_seqlen_q, max_seqlen_kv, max_batch_size, max_tokens_q, max_tokens_kv,
        d_qk, d_v, is_training, attn_scale, dropout, qkv_layout, bias_type, attn_mask_type,
        window_size_left, window_size_right, input_Q, input_K, input_V, input_Bias, output_O,
...
void nvte_fused_attn_bwd(const NVTETensor Q, const NVTETensor K, const NVTETensor V,
                         ...
                         size_t max_seqlen_kv, size_t max_batch_size, size_t max_tokens_q,
                         size_t max_tokens_kv, float attn_scale, float dropout,
  ...
  if (fused_attention_backend == NVTE_Fused_Attn_Backend::NVTE_F16_max512_seqlen) {
    ...
    fused_attn_arbitrary_seqlen_bwd(
        b, h_q, h_kv, max_seqlen_q, max_seqlen_kv, max_batch_size, max_tokens_q, max_tokens_kv,
        d_qk, d_v, attn_scale, dropout, qkv_layout, bias_type, attn_mask_type, window_size_left,
        window_size_right, deterministic, input_Q, input_K, input_V, input_O, input_dO, input_Bias,
        output_S, output_dQ, output_dK, output_dV, output_dBias, input_cu_seqlens_q,
