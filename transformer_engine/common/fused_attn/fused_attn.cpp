...
void nvte_fused_attn_fwd(const NVTETensor Q, const NVTETensor K, const NVTETensor V,
  ...
  if (fused_attention_backend == NVTE_Fused_Attn_Backend::NVTE_F16_arbitrary_seqlen) {
    ...
    fused_attn_fp8_fwd(b, h_q, h_kv, max_seqlen_q, max_seqlen_kv, d_qk, d_v, t_q, t_kv,
                       is_training, attn_scale, dropout, qkv_layout, o_format,
                       qkv_scale_inv_format, bias_type, attn_mask_type, softmax_type,
                       window_size_left, window_size_right, bottom_right_diagonal, input_Q,
                       input_K, input_V, input_SoftmaxOffset, input_output_S, output_O,
                       Aux_CTX_Tensors, input_cu_seqlens_q, input_cu_seqlens_kv,
...
void nvte_fused_attn_bwd(const NVTETensor Q, const NVTETensor K, const NVTETensor V,
  ...
  if (fused_attention_backend == NVTE_Fused_Attn_Backend::NVTE_F16_arbitrary_seqlen) {
    ...
    fused_attn_fp8_bwd(b, h_q, h_kv, max_seqlen_q, max_seqlen_kv, d_qk, d_v, t_q, t_kv,
                       attn_scale, dropout, qkv_layout, o_format, do_format, dqkv_layout,
                       qkv_scale_inv_format, do_scale_inv_format, bias_type, attn_mask_type,
                       ...
                       input_M, input_S, input_SoftmaxOffset, input_output_dP, output_dQ,
