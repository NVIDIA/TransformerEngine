...
void fused_topk_with_score_function_forward_kernel_launcher(
  ...
  cudaFuncSetAttribute(fused_topk_with_score_function_forward_kernel<DataType, BiasType>, cudaFuncAttributeMaxDynamicSharedMemorySize, shared_memory_size);
...
void fused_topk_with_score_function_backward_kernel_launcher(
  ...
  cudaFuncSetAttribute(fused_topk_with_score_function_backward_kernel<DataType>, cudaFuncAttributeMaxDynamicSharedMemorySize, shared_memory_size);
