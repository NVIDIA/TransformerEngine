...
void fused_score_for_moe_aux_loss_forward_kernel_launcher(
  ...
  cudaFuncSetAttribute(fused_score_for_moe_aux_loss_forward_kernel<DataType>, cudaFuncAttributeMaxDynamicSharedMemorySize, shared_memory_size);
...
void fused_score_for_moe_aux_loss_backward_kernel_launcher(
  ...
  cudaFuncSetAttribute(fused_score_for_moe_aux_loss_backward_kernel<DataType>, cudaFuncAttributeMaxDynamicSharedMemorySize, shared_memory_size);
