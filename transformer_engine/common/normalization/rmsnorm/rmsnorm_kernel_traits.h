...
#include "../common.h"
#include "../layernorm/ln_kernel_traits.h"
#include "../utils.cuh"
...
template <
    ...
    typename Base =
        normalization::Kernel_traits_finalize<HIDDEN_SIZE_, weight_t_, input_t_, output_t_, compute_t_,
...
template <typename weight_t_, typename input_t_, typename output_t_, typename compute_t_,
          ...
          typename Base = normalization::Kernel_traits<weight_t_, input_t_, output_t_, compute_t_,
