...
@triton.jit
def cross_entropy_recompute_forward_kernel(
    X_ptr,
    X_stride_0,
    X_stride_1,
    X_stride_2,
...
@triton.jit
def cross_entropy_recompute_tp_pre_kernel(
    X_ptr,
    X_stride_0,
    X_stride_1,
    X_stride_2,
...
@triton.jit
def cross_entropy_recompute_tp_post_kernel(
    gathered_data_ptr,
    Y_ptr,
    loss_ptr,
    stats_ptr,
...
@triton.jit
def cross_entropy_recompute_backward_kernel(
    logits_ptr,
    Y_ptr,
    stats_ptr,
    n_non_ignore_ptr,
