...
/*! \file quantize_4over6_kernel.cuh
...
#ifndef TRANSFORMER_ENGINE_QUANTIZE_4OVER6_KERNEL_CUH_
#define TRANSFORMER_ENGINE_QUANTIZE_4OVER6_KERNEL_CUH_
...
#include "../../utils.cuh"
#else
// NVRTC build: the host-only headers above are unavailable.
...
#endif  // TRANSFORMER_ENGINE_QUANTIZE_4OVER6_KERNEL_CUH_
