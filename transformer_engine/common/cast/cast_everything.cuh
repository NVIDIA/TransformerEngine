...
/*! \file cast_everything.cuh
 *  \brief All cast in one place.
 */

#ifndef TRANSFORMER_ENGINE_CAST_EVERYTHING_CUH_
#define TRANSFORMER_ENGINE_CAST_EVERYTHING_CUH_
...
#endif  // TRANSFORMER_ENGINE_CAST_EVERYTHING_CUH_
