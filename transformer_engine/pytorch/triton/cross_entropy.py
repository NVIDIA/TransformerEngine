...
def cross_entropy_kernel(
    ...
    # Second pass: write gradients into X_ptr
    for i in range(0, n_cols, BLOCK_SIZE):
        X_offsets = i + tl.arange(0, BLOCK_SIZE)
        ...
        if reduce_loss:
            # scale by the true number of non-ignored tokens
