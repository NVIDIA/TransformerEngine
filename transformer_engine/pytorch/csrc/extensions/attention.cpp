...
std::vector<py::object> fused_attn_fwd(
    ...
    size_t rng_elts_per_thread, bool return_max_sum_exp) {
  auto none = py::none();
  ...
  // f16_arbitrary:
  // return_max_sum_exp=false: S [b, h, sq, 1], rng_state [2], (optional) Bias [1, h, sq, skv], (optional) SoftmaxOffset [1, h, 1, 1]
