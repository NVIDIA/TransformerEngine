...
void mxfp8_scaling_compute_partial_amax(const at::Tensor &input,
                                        at::Tensor amax_rowwise,
                                        at::Tensor amax_colwise,
                                        int rows,
                                        int cols,
                                        size_t start_offset) {
  ...
  nvte_mxfp8_scaling_compute_partial_amax(input_cu.data(),
                                          amax_rowwise_cu.data(),
                                          amax_colwise_cu.data(),
                                          rows,
                                          cols,
                                          start_offset,
...
void mxfp8_scaling_partial_cast(const at::Tensor &input,
                                at::Tensor output_rowwise,
                                at::Tensor output_colwise,
                                const at::Tensor &scale_inv_rowwise,
                                const at::Tensor &scale_inv_colwise,
                                int rows,
                                int cols,
                                size_t start_offset) {
  TORCH_CHECK(input.is_contiguous(), "input must be contiguous");
  ...
  nvte_mxfp8_scaling_partial_cast(input_cu.data(),
                                  output_rowwise_cu.data(),
                                  output_colwise_cu.data(),
                                  scale_inv_rowwise_cu.data(),
                                  scale_inv_colwise_cu.data(),
                                  rows,
                                  cols,
                                  start_offset,
                                  at::cuda::getCurrentCUDAStream());
