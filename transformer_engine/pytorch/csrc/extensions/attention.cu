...
std::vector<at::Tensor> fused_attn_bwd_qkvpacked(
  ...
  nvte_fused_attn_bwd_qkvpacked(te_QKV.data(), te_O.data(), te_dO.data(), te_S.data(), te_dP.data(),
                                ...
                                attn_scale, p_dropout, qkv_layout, bias_type, attn_mask_type, window_size[0], window_size[1], deterministic,
...
std::vector<at::Tensor> fused_attn_bwd_kvpacked(
  ...
  nvte_fused_attn_bwd_kvpacked(
      ...
      max_seqlen_q, max_seqlen_kv, attn_scale, p_dropout, qkv_layout, bias_type, attn_mask_type, window_size[0], window_size[1], deterministic,
      workspace.data(), at::cuda::getCurrentCUDAStream());
...
std::vector<at::Tensor> fused_attn_bwd(
  ...
  nvte_fused_attn_bwd(te_Q.data(), te_K.data(), te_V.data(), te_O.data(), te_dO.data(), te_S.data(),
                      ...
                      max_seqlen_kv, attn_scale, p_dropout, qkv_layout, bias_type, attn_mask_type, window_size[0], window_size[1], deterministic,
                      workspace.data(), at::cuda::getCurrentCUDAStream());
