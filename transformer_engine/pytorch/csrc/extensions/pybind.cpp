...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("grouped_scaled_clamped_swiglu",
        transformer_engine::pytorch::grouped_scaled_clamped_swiglu,
  ...
  m.def("grouped_scaled_dswiglu", transformer_engine::pytorch::grouped_scaled_dswiglu,
        "Scaled SwiGLU backward + optional grouped quantize", py::arg("grad"),
        py::arg("fwd_input"), py::arg("act_scales"), py::arg("quantizer"),
        py::arg("num_tensors"), py::arg("first_dims"),
  ...
  m.def("grouped_scaled_clamped_dswiglu",
        ...
        py::arg("fwd_input"), py::arg("act_scales"), py::arg("quantizer"),
        py::arg("num_tensors"), py::arg("first_dims"),
        py::arg("tensor_offsets") = py::none(), py::arg("limit") = 7.0f,
  ...
  m.def("grouped_scaled_dsrelu", transformer_engine::pytorch::grouped_scaled_dsrelu,
        "Scaled SReLU backward + optional grouped quantize", py::arg("grad"),
        py::arg("fwd_input"), py::arg("act_scales"), py::arg("quantizer"),
        py::arg("num_tensors"), py::arg("first_dims"),
        py::arg("tensor_offsets") = py::none(),
        py::arg("compute_scale_grad") = true);
