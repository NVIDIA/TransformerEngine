...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  py::class_<te_torch::CommOverlapHelper>(m, "CommOverlapHelper", py::module_local())
  ...
  // communication)
  py::class_<te_torch::CommOverlap>(m, "CommOverlap", py::module_local())
      .def(py::init<torch::Tensor, te_torch::CommOverlapHelper &, int, int, int, int, int, bool,
                    bool>(),
           py::call_guard<py::gil_scoped_release>(), py::arg("sample"), py::arg("helper"),
           py::arg("tp_size"), py::arg("num_splits") = 4,
           py::arg("num_max_streams") = NVTE_COMM_OVERLAP_MAX_STREAMS, py::arg("cga_size") = 2,
           py::arg("num_comm_sm") = 16, py::arg("set_sm_margin") = true,
           py::arg("atomic_gemm") = false)
      .def("bulk_overlap", &te_torch::CommOverlap::bulk_overlap,
           py::call_guard<py::gil_scoped_release>())
      .def("atomic_gemm_overlap_rs", &te_torch::CommOverlap::atomic_gemm_overlap_rs,
           py::call_guard<py::gil_scoped_release>())
      .def("split_gemm_overlap_rs", &te_torch::CommOverlap::split_gemm_overlap_rs,
           py::call_guard<py::gil_scoped_release>())
      .def("set_ubuf_scale_inv", &te_torch::CommOverlap::set_ubuf_scale_inv,
           py::call_guard<py::gil_scoped_release>())
      .def("copy_input_to_ubuf", &te_torch::CommOverlap::copy_input_to_ubuf,
           py::call_guard<py::gil_scoped_release>())
      .def("get_ubuf_output", &te_torch::CommOverlap::get_ubuf_output,
           py::call_guard<py::gil_scoped_release>())
      .def("is_fp8_ubuf", &te_torch::CommOverlap::is_fp8_ubuf,
           py::call_guard<py::gil_scoped_release>())
      .def("is_atomic_gemm", &te_torch::CommOverlap::is_atomic_gemm,
           py::call_guard<py::gil_scoped_release>())
      .def("is_p2p_overlap", &te_torch::CommOverlap::is_p2p_overlap,
           py::call_guard<py::gil_scoped_release>());

  // Note: Can't release GIL in constructor since it may bootstrap
  // communicator with Python functions (e.g. PyTorch distributed
  // communication)
  py::class_<te_torch::CommOverlapP2P>(m, "CommOverlapP2P", py::module_local())
      .def(py::init<torch::Tensor, te_torch::CommOverlapHelper &, int, te::CommOverlapType, int,
                    int, int, bool, bool, bool, bool>(),
           py::call_guard<py::gil_scoped_release>(), py::arg("sample"), py::arg("helper"),
           py::arg("tp_size"), py::arg("comm_type"),
           py::arg("num_max_streams") = NVTE_COMM_OVERLAP_MAX_STREAMS, py::arg("cga_size") = 1,
           py::arg("num_comm_sm") = 1, py::arg("set_sm_margin") = false, py::arg("use_ce") = true,
           py::arg("atomic_gemm") = false, py::arg("aggregate") = false)
      .def("atomic_gemm_overlap_ag_p2p", &te_torch::CommOverlapP2P::atomic_gemm_overlap_ag,
           py::call_guard<py::gil_scoped_release>())
      .def("split_gemm_overlap_ag_p2p", &te_torch::CommOverlapP2P::split_gemm_overlap_ag,
           py::call_guard<py::gil_scoped_release>())
      .def("atomic_gemm_overlap_rs_p2p", &te_torch::CommOverlapP2P::atomic_gemm_overlap_rs,
           py::call_guard<py::gil_scoped_release>())
      .def("split_gemm_overlap_rs_p2p", &te_torch::CommOverlapP2P::split_gemm_overlap_rs,
           py::call_guard<py::gil_scoped_release>())
      .def("set_ubuf_scale_inv", &te_torch::CommOverlapP2P::set_ubuf_scale_inv,
           py::call_guard<py::gil_scoped_release>())
      .def("copy_input_to_ubuf", &te_torch::CommOverlapP2P::copy_input_to_ubuf,
           py::call_guard<py::gil_scoped_release>())
      .def("get_ubuf_output", &te_torch::CommOverlapP2P::get_ubuf_output,
           py::call_guard<py::gil_scoped_release>())
      .def("is_fp8_ubuf", &te_torch::CommOverlapP2P::is_fp8_ubuf,
           py::call_guard<py::gil_scoped_release>())
      .def("is_atomic_gemm", &te_torch::CommOverlapP2P::is_atomic_gemm,
           py::call_guard<py::gil_scoped_release>())
      .def("is_p2p_overlap", &te_torch::CommOverlapP2P::is_p2p_overlap,
           py::call_guard<py::gil_scoped_release>());
}
