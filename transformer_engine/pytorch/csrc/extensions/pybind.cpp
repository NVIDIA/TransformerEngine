...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("fa_prepare_bwd", &transformer_engine::pytorch::fa_prepare_bwd,
        ...
        py::call_guard<py::gil_scoped_release>());
  m.def("permute_to_grouped_tensor_fwd", &transformer_engine::pytorch::permute_to_grouped_tensor_fwd,
        "Permute Q, K, V to grouped tensors.",
        py::arg("query"), py::arg("key"), py::arg("value"), py::arg("original_layout"),
        py::call_guard<py::gil_scoped_release>());
  m.def("permute_to_grouped_tensor_bwd", &transformer_engine::pytorch::permute_to_grouped_tensor_bwd,
