...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("quantize_mxfp8_row_partition",
        transformer_engine::pytorch::quantize_mxfp8_row_partition, py::arg("tensor"),
        py::arg("quantizer"), py::arg("output"), py::arg("global_row_offset"),
        py::arg("global_rows"));
