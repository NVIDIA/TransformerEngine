...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  // fused router
    m.def("fused_topk_softmax_sigmod_fwd", &transformer_engine::pytorch::fused_topk_softmax_sigmod_fwd, 
        py::arg("logits"),
        py::arg("topk"),
        py::arg("use_pre_softmax"),
        py::arg("num_groups"),
        py::arg("group_topk"),
    ...
    m.def("fused_topk_softmax_sigmod_bwd", &transformer_engine::pytorch::fused_topk_softmax_sigmod_bwd, 
        py::arg("num_tokens"),
        py::arg("num_experts"),
        py::arg("routing_map"),
        py::arg("intermediate_output"),
        py::arg("grad_probs"),
        py::arg("topk"),
        py::arg("use_pre_softmax"),
        py::arg("scaling_factor"),
    ...
    m.def("fused_scores_for_aux_loss_fwd", &transformer_engine::pytorch::fused_scores_for_aux_loss_fwd, 
        py::arg("logits"),
        py::arg("topk"),
        py::arg("score_function"),
        "Fused topk softmax fwd");
    m.def("fused_scores_for_aux_loss_bwd", &transformer_engine::pytorch::fused_scores_for_aux_loss_bwd, 
        py::arg("num_tokens"),
        py::arg("num_experts"),
        py::arg("intermediate_output"),
        py::arg("grad_scores"),
        ...
        py::arg("score_function"),
        "Fused topk softmax bwd");
    m.def("fused_aux_loss_fwd", &transformer_engine::pytorch::fused_aux_loss_fwd, 
        py::arg("probs"),
