...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("swiglu", transformer_engine::pytorch::swiglu, "SwiGLU activation", py::arg("input"),
        py::arg("quantizer"));
  m.def("gpt_oss_swiglu", transformer_engine::pytorch::gpt_oss_swiglu, "SwiGLU activation used in GPT OSS", py::arg("input"),
  ...
  m.def("dswiglu", transformer_engine::pytorch::dswiglu, "Backward of SwiGLU", py::arg("grad"),
        py::arg("fwd_input"), py::arg("quantizer"));
  m.def("gpt_oss_dswiglu", transformer_engine::pytorch::gpt_oss_dswiglu, "Backward of SwiGLU used in GPT OSS", py::arg("grad"),
        py::arg("fwd_input"), py::arg("quantizer"), py::arg("limit") = 7.0f);
  /* DBias + DAct fusions*/
