...
std::vector<at::Tensor> te_gemm2(transformer_engine::Float8Tensor A, bool transa,
              transformer_engine::Float8Tensor B,
              bool transb, std::optional<at::Tensor> D, at::Tensor D_scale, transformer_engine::DType D_type,
...
std::vector<at::Tensor> te_gemm2(at::Tensor A, bool transa, at::Tensor B, bool transb, std::optional<at::Tensor> D,
