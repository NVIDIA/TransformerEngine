...
/* GLU (sigmoid gate) */
py::object glu(const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

py::object dglu(const at::Tensor &grad, const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

/* GELU and variants*/
py::object gelu(const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

py::object dgelu(const at::Tensor &grad, const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

py::object geglu(const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

py::object dgeglu(const at::Tensor &grad, const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

py::object qgelu(const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

py::object dqgelu(const at::Tensor &grad, const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

py::object qgeglu(const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

py::object dqgeglu(const at::Tensor &grad, const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

/* ReLU and variants*/
py::object relu(const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

py::object drelu(const at::Tensor &grad, const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

py::object reglu(const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

py::object dreglu(const at::Tensor &grad, const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

py::object srelu(const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

py::object dsrelu(const at::Tensor &grad, const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

py::object sreglu(const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

py::object dsreglu(const at::Tensor &grad, const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

/* Silu and variants*/
py::object silu(const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

py::object dsilu(const at::Tensor &grad, const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

py::object swiglu(const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

py::object dswiglu(const at::Tensor &grad, const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);

py::object clamped_swiglu(const at::Tensor &input, py::handle quantizer, std::optional<at::Tensor> qw, float limit, float alpha);
...
std::vector<py::object> dbias_dgelu(const at::Tensor &grad_output, const at::Tensor &act_input,
                                    py::handle quantizer, std::optional<at::Tensor> qw = std::nullopt);
