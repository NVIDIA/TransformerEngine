...
#define NBUF 2
  if ((*comm)->sm_arch >= 9 && (*comm)->ar2_nvsize > 1 &&
    ...
    NVTE_CALL_CHECK_CUDA_DRIVER("cuMulticastGetGranularity", &gran, &mcProp,
  ...
  error:
    ...
    close(fd);
    NVTE_CALL_CHECK_CUDA_DRIVER(
      "cuMulticastAddDevice", (*comm)->mc_handle, (CUdeviceptr)(*comm)->mydev);
    ...
    NVTE_CALL_CHECK_CUDA_DRIVER(
      "cuMemSetAccess", mc_va, mc_maxsize, const_cast<CUmemAccessDesc *>(&accessDesc), (size_t)1);
...
int register_user_buffer_collective(void **gpubuff, size_t bytes, communicator *comm, bool alloc) {
  ...
  error:
    ...
    NVTE_CALL_CHECK_CUDA_DRIVER(
      "cuMemSetAccess", ptr, (size_t)(aligned_size * nranks),
