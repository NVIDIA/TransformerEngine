...
std::pair<TensorWrapper, py::object> MXFP8Quantizer::create_tensor(const std::vector<size_t>& shape,
  ...
  if (internal) {
    ...
    PyObject* result = PyObject_Call(
        reinterpret_cast<PyObject*>(MXFP8TensorStoragePythonClass),
        PyTuple_New(0),
        kwargs);
    ...
    PyObject* result = PyObject_Call(
        reinterpret_cast<PyObject*>(MXFP8TensorPythonClass),
        PyTuple_New(0),
        kwargs);
...
std::pair<TensorWrapper, py::object> NVFP4Quantizer::create_tensor(const std::vector<size_t>& shape,
  ...
  if (internal) {
    ...
    PyObject* result = PyObject_Call(
        reinterpret_cast<PyObject*>(NVFP4TensorStoragePythonClass),
        PyTuple_New(0),
        kwargs);
    ...
    PyObject* result = PyObject_Call(
        reinterpret_cast<PyObject*>(NVFP4TensorPythonClass),
        PyTuple_New(0),
        kwargs);
