...
// TODO(mkozuki): Consider using transformer_engine/common/layer_norm/ln.h
// instead
//    once the FP8 recipe for eMHA is figured out.
//    To my knowledge, major differences are in FwdParams (and BwdParams), more
//    specifically, the pointers of `scale`, `scale_inv`, `amax` and the boolean
//    of `fp8_out`.
// This file could be different from
// transformer_engine/common/layer_norm/ln.half in that this does NOT take FP8
// into consideration.
//
// Clone of
// https://github.com/NVIDIA/apex/tree/3c88451afbbf5b835ce0ff21165b48787feeeab4/apex/contrib/csrc/layer_norm/ln.h
...
struct FwdParams : public ParamsBase {
  FwdParams() : ParamsBase(), z(nullptr), beta(nullptr), epsilon(0.f) {}
