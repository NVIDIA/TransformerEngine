...
//
// Clone of
// https://github.com/NVIDIA/apex/blob/3c88451afbbf5b835ce0ff21165b48787feeeab4/apex/contrib/csrc/multihead_attn/philox.cuh

namespace {

class Philox {
 public:
  __device__ inline Philox(u_int64_t seed,
                           u_int64_t subsequence,
                           u_int64_t offset)
      : STATE(0) {
 ...
 private:
  ...
  uint2 key;
  unsigned int STATE;
  __device__ inline void incr_n(u_int64_t n) {
  ...
  static const u_int32_t kPhilox10A = 0x9E3779B9;
  static const u_int32_t kPhilox10B = 0xBB67AE85;
  static const u_int32_t kPhiloxSA = 0xD2511F53;
  static const u_int32_t kPhiloxSB = 0xCD9E8D57;
};
// Inverse of 2^32.
