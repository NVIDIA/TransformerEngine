...
cutlass_tensorop_f16_s16816gemm_f16_128x128_32x5_nn_align8_base>::value);
*/
...
void cuda_bmm_nn(int m, int n, int k, float alpha, half const *A, int lda,
                 ...
                 cudaStream_t stream) {
  using Gemm_nn = cutlass::gemm::device::GemmUniversalAdapter<
      cutlass_tensorop_f16_s16816gemm_f16_128x128_32x5_nn_align8>;
  using Arguments = typename Gemm_nn::Arguments;
