...
def fused_attn_fwd_qkvpacked(
    ...
    cu_seqlens_with_padding: torch.Tensor = None,
    ...
    cu_seqlens_with_padding: torch.Tensor, default = None
...
def fused_attn_fwd_kvpacked(
    ...
    fused_attention_backend: tex.NVTE_Fused_Attn_Backend,
    attn_bias: torch.Tensor = None,
    cu_seqlens_q_with_padding: torch.Tensor = None,
    cu_seqlens_kv_with_padding: torch.Tensor = None,
    d_scale_qkv: torch.Tensor = None,
    d_scale_s: torch.Tensor = None,
    q_scale_s: torch.Tensor = None,
    q_scale_o: torch.Tensor = None,
    ...
    cu_seqlens_q_with_padding: torch.Tensor, default = None
                cumulative sequence offsets for Q; shape [batch_size + 1]
    cu_seqlens_kv_with_padding: torch.Tensor, default = None
