    ...
    def backward(
        ...
        with get_nvtx_range_context("_GroupedLinear_backward"):
            ...
            if ctx.gtp_size == 1:
                ...
                gtp_origin_weights = None
            else:
                inputmats = saved_tensors[:N]
                gtp_origin_weights = saved_tensors[N : 2 * N]
            ...
            if ctx.gtp_size > 1:
                ...
                origin_weights = gtp_origin_weights
            ...
            if ctx.weights_requires_grad:
                ...
                if ctx.fuse_wgrad_accumulation:
                    ...
                    weight_shape = w_shape if ctx.gtp_size > 1 else list(weights[0].size())
...
class GroupedLinear(TransformerEngineBaseModule):
    ...
    def __init__(
        ...
        maybe_wrap_gtp(self, self.weight_names, gtp_group, is_grouped=True)
