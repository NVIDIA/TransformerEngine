...
#         use_metis = False
#     ) -> torch.Tensor:
#         # print("runtime forward metis context = ",LinearLowbitContext())
#         # pylint: disable=missing-function-docstring

#         # NVTX label for profiling
#         nvtx_label = "transformer_engine.MetisSvdFunction.forward"
...
#                 if use_metis:
#                     # Metis Lowbit context is used
#                     if LinearLowbitContext.enable_activation_svd:
#                         pass
...
#         # pylint: disable=missing-function-docstring
#         debugpy.breakpoint()
#         # print("runtime backward metis context = ",ctx.metis_context)
#         # NVTX label for profiling
#         nvtx_label = "transformer_engine.MetisSvdFunction.backward"
#         if ctx.ub_name is not None:
#             nvtx_label = f"{nvtx_label}.{ctx.ub_name}"

#         with torch.cuda.nvtx.range("MetisSvdFunction_backward"):
...
#                 grad_output,
#                 grad_bias,
#             ) = MetisSvdFunction.grad_output_preprocess(
#                 ctx,
#                 grad_output,
...
#                     ),
#                 ):
#                     if ctx.use_metis and ctx.metis_context.enable_backward_svd:
...
# class MetisLowBitLinear(TransformerEngineBaseModule):
...
#                 linear_fn = MetisSvdFunction.apply
#                 args = []
#             else:
#                 linear_fn = MetisSvdFunction.forward
#                 args = [None]
#             args += (
#                 weight_tensor,
#                 inp,
...
class MetisLinear(TransformerEngineBaseModule):
    ...
    def initialize_weight_svd_decomposition(self):
        ...
        if LinearLowbitContext.forward_svd_rank > 0:
            self.linear_residual = MetisLinear(
