...
class DotProductAttention(TransformerEngineBaseModule):
    ...
    def forward(
        ...
        .. note::
            ...
            Users can use environment variables :attr:`NVTE_FLASH_ATTN` and
            :attr:`NVTE_FUSED_ATTN` to control which DotProductAttention backend to use.
            Transformer Engine first filters backends by support for the runtime environment and
            input configuration, then applies a performance-based preference order. On supported
            pre-Hopper GPUs, FlashAttention is preferred over FusedAttention and
