...
class MultiheadAttention(torch.nn.Module):
    ...
    def set_context_parallel_group(
        ...
        if isinstance(cp_group, dist_group_type):
            ...
            assert len(cp_group) == 3, "cp_comm_type = a2a+p2p requires three CP groups, [global_cp_group, a2a_cp_group, p2p_cp_group]!"
            assert (
            ...
            assert cp_size == self.cp_size, "The size of cp_group[0] does not match the combined size of cp_group[1] and cp_group[2] in cp_comm_type = a2a+p2p!"
