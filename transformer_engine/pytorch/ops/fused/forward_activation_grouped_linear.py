...
"""Fused scaled activation + grouped linear forward."""
...
_ScaledActivation = _ScaledGLU | _ScaledUnary
_SCALED_ACTIVATION_TYPES = (_ScaledGLU, _ScaledUnary)
...
def _grouped_scaled_activation(
    ...
    """Dispatch a grouped scaled activation."""
