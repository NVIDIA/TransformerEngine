...
class LinearCrossEntropy(torch.autograd.Function):
    ...
    def forward(
        ...
        with torch.cuda.nvtx.range("LinearCrossEntropy-forward"):
            ...
            logprobs, _maximum, _acc = linear_cross_entropy_kernels.efficient_entropy_forward(
                hidden, weight, labels, REDUCTION, dist_process_group
            )
    ...
    def backward(ctx, dlogprobs: torch.Tensor) -> typing.List[torch.Tensor]:
        ...
        with torch.cuda.nvtx.range("LinearCrossEntropy-backward"):
            ...
            d_hidden, d_weight = linear_cross_entropy_kernels.efficient_entropy_backward(
                dlogprobs, hidden, weight, labels, _maximum, _acc, REDUCTION, dist_process_group
            )
