...
from .utils import needs_quantized_gemm, non_tn_fp8_gemm_supported, safely_set_viewless_tensor_data
...
def has_te_modules(network):
    ...
    """
    from .attention import DotProductAttention, MultiheadAttention, UnfusedDotProductAttention
